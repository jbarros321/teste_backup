...
- **Aceleração por GPU:** Para rodar o Ollama usando o processamento da sua placa de vídeo (GPU) NVIDIA ou AMD, siga o guia completo em [CONFIGURACAO_GPU.md](../CONFIGURACAO_GPU.md).
