...
class InserirPedidoMegleoBkp.2
implements JapeSession.TXBlock {
    ...
    InserirPedidoMegleoBkp.2(String string, String string2, BigDecimal bigDecimal, String string3, String string4, BigDecimal bigDecimal2, String string5, String string6) {
