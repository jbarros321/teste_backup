    ...
    <%@ taglib prefix="snk" uri="/WEB-INF/tld/sankhyaUtil.tld" %>
        <%-- mitralab.jsp - casca (shell) para rodar um projeto MitraLab dentro do Sankhya. A tela do Sankhya carrega
            ...
            <% /*==================CONFIGURACAO==================Troque APENAS a URL abaixo pela URL do projeto
                ...
                iframe fica em branco). */ String URL_APP="https://agent.mitralab.io/w/142461/p/61147/code-builder" ; String
                TITULO="MitraLab" ; boolean BARRA=true; /* barra superior com usuario logado / recarregar */ boolean
