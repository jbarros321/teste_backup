/* =====================================================================
   06 - QUERY DA TELA INDICADORES (estrutura ESTR_DRE_TW.ID = 7)
   Versao adaptada para o projeto de destino (tenant_47255).

   Diferenca para a query original (queryDadosBPindicadores.sql):
