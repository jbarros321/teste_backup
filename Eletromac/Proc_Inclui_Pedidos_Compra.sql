...
*/ ----------------------------------------------------------------------------
  ...
  (SELECT COM.CODEMP AS CODEMP
      ...
      FROM (SELECT COM.CODEMP
                 ...
                 , COM.CODPARC
                 , COM.SOLCOMPRA
                 , TRUNC(SNK_DIVIDIR(SUM(COM.SUGESTAO) - SUM(COM.SOMPEDPEN), COM.QTDEMB) - 0.099) * COM.QTDEMB AS SUGESTAO
...
BEGIN
   ...
   INSERT INTO TGFCAB (NUNOTA, NUMNOTA, CODEMP, DTNEG, DTENTSAI, DTMOV, HRMOV, CODEMPNEGOC, CODPARC, RATEADO,
                       ...
                       AGRUPBOL, PRODUETLOC)
               VALUES (P_NUNOTA, P_NUMNOTA, N_CODEMP, N_DTNEG, N_DTENTSAI, N_DTMOV, N_HRMOV, N_CODEMPNEGOC, N_CODPARC, N_RATEADO,
     ...
     INSERT INTO TGFITE (NUNOTA, SEQUENCIA, CODEMP, CODLOCALORIG, CODPROD, CONTROLE, CODVOL, CODVEND,
                         ...
                         PERCDESC)
                 VALUES (P_NUNOTA, P_SEQUENCIA, I_CODEMP, I_CODLOCALORIG, I_CODPROD, I_CONTROLE, I_CODVOL, I_CODVEND,
