...
ÍNDICE ................................................................................................................................................................... 3
HISTÓRICO DE VERSÕES DO MANUAL ................................................................................................... 9
PARTE I - MODELO CONCEITUAL DO SISTEMA NACIONAL NFS-E .......................................... 11
1. INTRODUÇÃO............................................................................................................................................... 12
2. O SISTEMA NACIONAL NFS-E .............................................................................................................. 15
3. MÓDULOS DO SISTEMA NACIONAL NFS-E .................................................................................... 16
   ...
   3.4. CADASTRO NACIONAL DE CONTRIBUINTES NFS-E (CNC NFS-E) (EM DESENVOLVIMENTO) ................... 18
...
   7.4. EVENTOS DE NFS-E ........................................................................................................................................... 31
     ...
     7.4.4. Cancelamento de NFS-e Deferido por Análise Fiscal .................................................................................... 32
...
NACIONAL NFS-E ............................................................................................................................................ 36
11. CONTROLE DE ACESSO AO SISTEMA NACIONAL NFS-E – MUNICÍPIOS ...................... 37
...
                 a.     GET – /parametros_municipais/{codigoMunicipio}/convenio ............................................................................... 86
                 ...
                 d.     GET – /parametros_municipais/{codigoMunicipio}/retencoes .............................................................................. 86
...
DE DF-E ................................................................................................................................................................ 92
   ...
   15.2. API DF-E PARA MUNICÍPIOS .......................................................................................................................... 93
     15.2.1. Descrição ............................................................................................................................................... 93
                 ...
                 d.     Consulta de NFS-e por Chave de Acesso Informada .............................................................................................. 94
       15.2.2. Métodos .................................................................................................................................................. 94
                 a.     POST /DFe/............................................................................................................................................................. 94
                 b.     GET /DFe/{UltimoNSU} .......................................................................................................................................... 95
                 c.     GET /DFe/{NSU} ..................................................................................................................................................... 95
   15.3. API DANFSE ................................................................................................................................................... 96
     15.3.1. Descrição ............................................................................................................................................... 96
     15.3.2. Métodos .................................................................................................................................................. 96
...
   16.4.1. Verificar Certificado Digital da Assinatura do DF-e ................................................................................. 109
 ...
 16.5. CONTROLE DE ACESSO AO SISTEMA NACIONAL NFS-E PARA O EMISSOR MÓVEL .................................. 109
   16.5.1. API para Emitir Token para controle de acesso do Emissor Móvel .......................................................... 109
...
local.
 ...
 Fluxo de Distribuição de Documentos Fiscais eletrônicos (DF-e) – Arquitetura API ADN NFS-e
                                                                            Município
                                                                            Incidência
                    Recepção de DF-e                                         do ISSQN
                     Pelo ADN NFS-e

                                       ADN NFS-e                            Município
  Município                                                                  Local da
  Emissor         Internet         API Municípios           Internet       Prestação do
                                       (POST)                                Serviço

                                           Distribuição de DF-e             Municípios
                                             Pelo ADN NFS-e
                                                                             dos Não
                                                                           Emitentes da
                                                                              NFS-e
...
Esquema XML: xmldsig-core-schema_v1.01.xsd
    CAMINHO NO XML                  CAMPO             ELE. TIP OCOR TAM              DESCRIÇÃO
                                                            O    .   .
...
NFSe/Signature/                       URI              A    E   1-1  -     Atributo URI da tag Reference
SignedInfo/Reference/
NFSe/Signature/                   Transforms           G   E   1-1    -    Grupo do algorithm de Transform
SignedInfo/Reference/
NFSe/Signature/                unique_Transf_Alg      RC   E   1-1    -    Regra para o atributo Algorithm do
SignedInfo/Reference/                                                            Transform ser único.
Tranforms/
NFSe/Signature/                    Transform           G   E   2-2    -          Grupo de Transform
SignedInfo/Reference/
Tranforms/
NFSe/Signature/                    Algorithm           A   E   1-1    -       Atributos válidos Algorithm do
SignedInfo/Reference/                                                                   Transform:
Tranforms/Transform/                                                       http://www.w3.org/TR/2001/REC-
                                                                                   xml-c14n-20010315
                                                                          http://www.w3.org/2000/09/xmldsig
                                                                                  #enveloped- signature
NFSe/Signature/                      XPath             E   E   0-N    -                    XPath
SignedInfo/Reference/
Tranforms/Transform
NFSe/Signature/                  DigestMethod          G   E   1-1    -    Grupo do Método de DigestMethod
SignedInfo/Reference/
NFSe/Signature/                    Algorithm           A   E   1-1    -   Atributo Algorithm de DigestMethod:
SignedInfo/Reference/                                                     http://www.w3.org/2000/09/xmldsig
DigestMethod/                                                                             #sha1
NFSe/Signature/                   DigestValue          E   E     1    -   Digest Value (Hash SHA-1 – Base64)
SignedInfo/Reference/
...
NFSe/Signature/                 X509Certificate        E   E   1-1    -   Certificado Digital X509 em Base64
KeyInfo/X509Data/
 ...
 <DPS xmlns="http://www.sped.fazenda.gov.br/nfse" versao="1.00">
    ...
    <Signature xmlns="http://www.w3.org/2000/09/xmldsig#">
       <SignedInfo>
            ...
            <Reference URI="#ID ID310620011000053926126280000000000000190101">
                 <Transforms>
...
nome ou pelo CPF, conforme tabela abaixo:
 ...
 Novo Gestor    inclusão de novo    Botão            Incluir
                                                                            um gestor
                 Gestor Nacional
                   Botão para                                     Atualizar a consulta exibida na
   Atualizar                        Botão           Atualizar
                 atualizar a tela                                          tela ao inicial
                   Texto para
    Texto                           Texto     Refinar pesquisa    Receber texto a ser pesquisado
                     pesquisa
                  Pesquisa por
                  nome ou CPF
               (Se a consulta for                                Recuperar os dados para o CPF ou
  Pesquisar                         Botão           Pesquisar
               por CPF informar                                          Nome informado
                    apenas os
                    números)
...
                                                                                            Manual de Integração
   ...
   Campo           Descrição          Tipo        Funcionalidade                         Ação
     ...
     CPF                             Numérico            Exibir                             -
                 ...
                 Nome do gestor
   Nome do
                  recuperado no       Texto              Exibir                             -
    gestor
                   cadastro CPF
                Nome do órgão a
    Órgão        que pertence o       Combo              Exibir                             -
                       gestor
                Situação atual do
                    cadastro do
   Situação                           Texto              Exibir                             -
                       gestor
                 (Ativo/Inativo)
                 Data da última
 Atualização      atualização do       Data              Exibir                             -
                     cadastro
                                                                             Direcionar para efetuar a ação
                                                                             selecionada
                 Alterar situação                                                •   Se Ativo, pode-se:
   Ações no     atual do gestor no                                                       o Editar
                                      Botão              Alterar
   registro          cadastro                                                            o Inativar
                                                                                 •   Se Inativo, pode-se:
                                                                                         o Editar
                                                                                         o Ativar
...
cadastro.
     ...
     Campo                Descrição              Tipo       Funcionalidade                      Ação
                                                                                         Pesquisar nome
                       CPF do gestor a ser
       CPF                                      Numérico           Pesquisar           relacionado ao CPF
                           pesquisado
                                                                                            informado
                         Nome do gestor
  Nome do gestor     recuperado no cadastro      Texto              Exibir                       -
                              CPF
                                                                                     Incluir o nome do órgão
                      Nome do órgão a que
      Órgão                                      Combo              Incluir           do gestor no campo de
                       pertence o gestor
                                                                                           preenchimento
                                                                                   Incluir número do telefone
                     Número de telefone de
     Telefone                                   Numérico            Incluir          de contato do gestor no
                       contato do gestor
                                                                                    campo de preenchimento
                                                                                         Incluir o endereço
                     Endereço eletrônico do     Endereço
      E-mail                                                        Incluir           eletrônico do gestor no
                            gestor              de e-mail
                                                                                    campo de preenchimento
                                                                                      Efetivar o cadastro do
                     Cadastrar informações
    Cadastrar                                    Botão              Incluir        gestor nacional no sistema
                           do gestor
                                                                                              nacional
                     Cancelar o processo de                                         Desfazer as inclusões do
     Cancelar          cadastramento do          Botão             Cancelar            cadastro de gestores
                             gestor                                                           nacionais
...
tabela abaixo. As informações alteradas são registradas em uma tabela de Histórico.
     ...
     Campo                 Descrição             Tipo       Funcionalidade             Ação
        ...
        CPF                                     Numérico        Exibir                    -
                             selecionado
                           Nome do gestor
       Nome           recuperado no cadastro     Texto          Exibir                    -
                                 CPF
                        Nome do órgão a que                                   Alterar o nome do órgão
       Órgão                                     Combo          Alterar
                          pertence o gestor                                            do gestor
                      Número de telefone de                                  Alterar número do telefone
     Telefone                                   Numérico        Alterar
                          contato do gestor                                     de contato do gestor
                      Endereço eletrônico do    Endereço                          Alterar o endereço
      E-mail                                                    Alterar
                                gestor          de e-mail                        eletrônico do gestor
                        Situação do cadastro
   Situação Atual             do gestor          Texto          Exibir                    -
                           (Ativo/Inativo)
                           Data da última
 Última Atualização                               Data          Exibir                    -
                             atualização
                         Salvar as alterações
                                                                             Efetivar as alterações das
      Salvar             das informações do      Botão          Alterar
                                                                               informações do gestor
                                gestor
                      Cancelar o processo de                                 Desfazer as alterações do
     Cancelar               alteração das        Botão         Cancelar        cadastro de gestores
                       informações do gestor                                        nacionais
...
Novo Convênio inclusão de novo       Botão       Incluir
                                                                             convênio
                    Convênio
                   Botão para
   Reiniciar                         Botão      Reiniciar             Retorna a tela ao início
                reiniciar a tela
                   Texto para
    Texto                            Texto   Refinar pesquisa     Receber texto a ser pesquisado
                    pesquisa
              Pesquisa por nome                                 Recuperar os dados para o Nome do
  Pesquisar                          Botão      Pesquisar
                  do município                                         município informado
                    Nome do
  Município                          Texto        Exibir                         -
                   município
                     Data da
  Publicação     publicação do       Data         Exibir                         -
                    convênio
               Situação atual do
                    convênio
   Situação      (Cadastrado,        Texto        Exibir                         -
                 Ativo, Inativo,
                   Suspenso)
                                                                Direcionar para efetuar a ação
                                                                selecionada
                   ...
                   alteração do
                                                                            o Inativar
    Ações       convênio conforme    Botão       Alterar
                                                                    •   Se Ativo, pode-se:
                sua situação atual
                                                                            o Editar
                                                                            o Inativar
...
o cadastramento são conforme tabela abaixo.
     ...
     Município         qual se deseja cadastrar     Combo
                                                                   Pesquisar            município na
                             um convênio
                                                                                    relação apresentada
                           CNPJ do Município
       CNPJ                                             Texto        Exibir                   -
                              selecionado
                          Código do Município
    Código IBGE                                         Texto        Exibir                   -
                      conforme tabela do IBGE
                        Razão Social conforme
    Razão Social                                        Texto        Exibir                   -
                             cadastro CNPJ
    Logradouro           Nome do logradouro             Texto        Exibir                   -
     Número             Número do logradouro            Texto        Exibir                   -
                            Complemento do
   Complemento                                          Texto        Exibir                   -
                               logradouro
                           Número do CPF do
 CPF do responsável    responsável por gerir as         Texto        Exibir                   -
                      informações do município
      Nome do            Nome do responsável
                                                        Texto        Exibir                   -
    responsável         conforme cadastro CPF
                                                    Numérico
                       Número da Lei Municipal                                      Incluir o número da
   Número da Lei                                     (Até 8
                      que autorizou a criação do                    Incluir          Lei Municipal que
     Municipal                                      posições
                              convênio                                                criou o convênio
                                                   numéricas)
                      Data da Lei Municipal que                                     Incluir a data da Lei
    Data da Lei
                       autorizou a criação do           Data        Incluir         Municipal que criou
     Municipal
                              convênio                                                   o convênio
                                                                                        Edita/Alterar
                        Número do convênio
Número do convênio                                      Texto       Incluir              número do
                            municipal
                                                                                     convênio Municipal
                        Data da publicação do
                        convênio municipal no
 Data da publicação      Diário do Município                                          Incluir a data do
                                                        Data        Incluir
    do convênio        (Deverá ser maior que a                                       Convênio Municipal
                          data da Lei que o
                              autorizou)
                                                                                      Incluir a data em
                       Data em que o convênio
 Data da entrada em                                                                    que o Convênio
                      passa a vigorar no sistema        Data        Incluir
        vigor                                                                        Municipal passa a
                                NFS-e
                                                                                           vigorar
                                                                                          Incluir as
                       Observações pertinentes                                       observações sobre
    Observações                                         Texto       Incluir
                            ao convênio                                                  o Convênio
                                                                                          Municipal
                      Cadastrar informações do                                       Efetivar a inclusão
     Cadastrar                                          Botão       Incluir
                              convênio                                                  do convênio
                       Cancelar o processo de                                       Desfazer o processo
      Cancelar           cadastramento do               Botão      Cancelar          de cadastramento
                              convênio                                                  do convênio
...
preenchimento conforme tabela abaixo.
 ...
 CPF do responsável    responsável por gerir as      Texto           Exibir                    -
      ...
      Nome do            Nome do responsável
                                                     Texto           Exibir                    -
    responsável         conforme cadastro CPF
    Situação do          Situação do Convênio
                                                     Texto           Exibir                    -
     Convênio                   (Inativar)
                                                    Numérico
                       Número da Lei Municipal                                          Editar/Alterar
   Número da Lei                                     (Até 8
                      que autorizou a criação do                 Editar/Alterar         número da Lei
     Municipal                                      posições
                              convênio                                                    Municipal
                                                   numéricas)
...
                                                                                            Manual de Integração
     ...
     Data da Lei                                                                          Editar/Alterar data
                        autorizou a criação do           Data        Editar/Alterar
      Municipal                                                                            da Lei Municipal
                               convênio
                                                                                            Editar/Alterar
     Número do            Número do convênio
                                                       Texto         Editar/Alterar          número do
      convênio                municipal
                                                                                          convênio Municipal
                         Data da publicação do
                         convênio municipal no
                                                                                          Editar/Alterar data
 Data da publicação       Diário do Município
                                                         Data        Editar/Alterar          do Convênio
    do convênio         (Deverá ser maior que a
                                                                                               Municipal
                           data da Lei que o
                              autorizou)
                                                                                          Editar/Alterar data
                        Data em que o convênio
  *Data da entrada                                                                        em que o Convênio
                          passa a vigorar no             Data        Editar/Alterar
     em vigor                                                                              Municipal passa a
                            sistema NFS-e
                                                                                                 vigorar
                                                                                            Editar/Alterar as
                       Observações pertinentes                                             observações sobre
    Observações                                        Texto         Editar/Alterar
                            ao convênio                                                       o Convênio
                                                                                                Municipal
                          Salvar as alterações                                                 Efetivar as
       Salvar                                          Botão             Alterar
                               efetuadas                                                       alterações
                                                                                          Desfazer o processo
                         Cancelar o processo de
                                                                                            de alteração das
      Cancelar         alteração das informações       Botão            Cancelar
                                                                                            informações do
                              do convênio
                                                                                                convênio
...
inativação. Uma vez desativado não ocorre exclusão física do sistema apenas exclusão lógica.
       ...
       Campo                   Descrição             Tipo       Funcionalidade                Ação
                          Número do convênio
 Número do convênio                                  Texto           Exibir                      -
                                municipal
                          Situação do Convênio
     Situação do
                        (Cadastrado, Suspenso ou     Texto           Exibir
      Convênio
                                 Ativo)
                           Nome do Município
 Nome do Município                                   Texto           Exibir                      -
                          conforme tabela TOM
                                                                                        Incluir motivo para
                        Motivo para inativação do
  Motivo Inativação                                  Texto          Incluir           inativação do convênio
                         convênio do município
                                                                                            do município
                                                                                      Efetivar a inativação do
                        Confirmar a inativação do
      Confirmar                                      Botão          Inativar          convênio do município
                         convênio do município
                                                                                            referenciado
                          Cancelar o processo de                                      Desfazer o processo de
       Cancelar         inativação do convênio do    Botão         Cancelar           inativação do convênio
...
Nome do Município                                Texto       Exibir                  -
 ...
 Motivo Reativação                               Texto       Incluir      reativação do convênio
                      convênio do município
                                                                                do município
                     Confirmar a reativação do                            Efetivar a reativação do
    Confirmar         convênio do convênio do    Botão      Reativar       convênio do município
                             município                                          referenciado
                       Cancelar o processo de
                                                                          Desfazer o processo de
     Cancelar        reativação do convênio do   Botão      Cancelar
...
incluir um novo gestor, pesquisar gestor pelo nome ou pelo CPF, conforme campos abaixo:
        ...
        Campo              Descrição            Tipo     Funcionalidade                     Ação
       Novo Gestor      Botão para inclusão     Botão            Incluir        Apresenta tela para inclusão de
                          de novo Gestor                                                  um gestor
                             Nacional
        Reiniciar      Botão para reiniciar a   Botão           Reiniciar           Retorna a tela ao início
                                tela
...
                                                                                                     Manual de Integração
      ...
      Pesquisar        Pesquisa por nome ou     Botão             Pesquisar              Recuperar os dados para o CPF
                       CPF (Se a consulta for                                                 ou Nome informado
                          por CPF informar
                       apenas os números.)
         CPF             Número do CPF do       Texto              Exibir                              -
                                Gestor
        Nome              Nome do Gestor        Texto              Exibir                              -
        Perfil           Nome do perfil do      Texto              Exibir                              -
                        Gestor na aplicação
       Situação        Situação do Gestor na    Texto              Exibir                              -
                              aplicação
     Atualização           Data da última       Data               Exibir                              -
                           atualização das
                           informações do
                                Gestor
   Ações no registro   Alterar situação atual   Botão              Alterar               Direcionar para efetuar a ação
                       do gestor no cadastro                                                      selecionada:
                                                                                            •   Ativo
                                                                                                     o    Editar
                                                                                                     o    Inativar
                                                                                            •   Inativo
...
em um mesmo período de tempo.
      ...
      Campo                  Descrição                 Tipo       Funcionalidade                        Ação
         CPF              CPF do gestor a ser         Numérico          Pesquisar            Pesquisar nome relacionado
                               pesquisado                                                        ao CPF informado
   Nome do gestor            Nome do gestor             Texto                Exibir                      -
                        recuperado no cadastro
                                   CPF
     Tipo Gestor        Permite definir o tipo do      Combo           Selecionar               Incluir o tipo do gestor
                          gestor a ser incluído                                                       selecionado
                           •    Principal;
                           •    Auditor;
                           •    Parametrizador;
                           •    Atendente;
       Telefone          Número de telefone de        Numérico              Incluir           Incluir número do telefone
                           contato do gestor                                                     de contato do gestor
        E-mail           Endereço eletrônico do       Endereço              Incluir          Incluir o endereço eletrônico
                                 gestor               de e-mail                                         do gestor
      Cadastrar        Cadastrar informações do         Botão               Incluir          Efetivar a inclusão do gestor
                                 gestor
       Cancelar         Cancelar o processo de         Botão            Desfazer                Desfazer o processo de
                       cadastramento do gestor                                                 cadastramento do gestor
...
alteradas são registradas em uma tabela de Histórico.
    ...
    Nome do gestor             Nome do gestor           Texto                 Exibir                        -
                          recuperado no cadastro
                                    CPF
      Tipo Gestor         Permite alterar o tipo do     Combo               Selecionar          Alterar o tipo do gestor
                                   gestor
                             •   Principal;
                             •   Auditor;
                             •   Parametrizador;
...
                                                                                          Manual de Integração
       ...
       Telefone            Número de telefone de       Numérico        Alterar         Alterar número do
                             contato do gestor                                       telefone de contato do
                                                                                             gestor
        E-mail             Endereço eletrônico do      Endereço        Alterar         Alterar o endereço
                                    gestor             de e-mail                      eletrônico do gestor
     Situação Atual       Situação do cadastro do        Texto          Exibir                  -
                            gestor (Ativo/Inativo)
   Última Atualização    Data da última atualização      Data          Exibir                    -
         Salvar           Salvar as alterações das       Botão         Alterar      Efetivar as alterações das
                           informações do gestor                                      informações do gestor
       Cancelar            Cancelar o processo de        Botão         Desfazer      Desfazer o processo de
                         alteração das informações                                  cadastramento do gestor
                                  do gestor
...
As informações do município que devem ser definidas no fluxo inicial de parametrização são:
    ...
    Complemento             Complemento de             Texto           Exibir                   -
     ...
     Logradouro           Nome do logradouro           Texto           Exibir                     -
      Número             Número do logradouro          Texto           Alterar         Alterar o número do
                                                                                            logradouro
    Complemento              Complemento do            Texto           Alterar      Alterar o complemento do
                                logradouro                                                  logradouro
       Bairro                 Nome do bairro           Texto           Exibir                     -
       E-mail               Endereço do e-mail      Endereço de        Alterar       Alterar o endereço de e-
                        cadastrado como contato       e-mail                              mail do contato
                               no município
      Telefone              Número do telefone        Numérico         Alterar        Alterar o número do
                        cadastrado como contato                                       telefone do contato
                               no município
     Página Web          Endereço da página web
                               do município
       Brasão             Imagem do brasão que          img            Alterar        Alterar a imagem do
                         será incluído na geração                                     brasão do município
                        do DANFSe das NFS-e do
                             município emissor
       Salvar              Salvar alterações das       Botão           Alterar       Efetivar a alteração do
                        informações do município                                            município
                                cadastrado
...
incluir um novo gestor, pesquisar gestor pelo nome ou pelo CPF, conforme campos abaixo:
      ...
      Campo                 Descrição            Tipo     Funcionalidade                     Ação
 Nova Legislação para    Botão para inclusão     Botão            Incluir        Apresenta tela para inclusão de
       o ISSQN            de nova Legislação                                               um gestor
                             para o ISSQN
       Reiniciar        Botão para reiniciar a   Botão           Reiniciar           Retorna a tela ao início
                                  tela
        Texto            Texto para pesquisa     Texto        Refinar pesquisa   Receber texto a ser pesquisado
...
município.
 ...
 Aderência a
 Módulos do          Ambientes de Dado
                                                Checkbox       Obrig.       Pré-definido             -
   Sistema          Nacional – ADN NFS-E
Nacional NFS-e
                     Emissores Públicos                                                         Definir se o
                           Nacionais                                                           município vai
 Aderência a
                     (WEB, Móvel e API)                                                          utilizar os
 Módulos do
                  Indicar se o município vai    Checkbox       Obrig.        Selecionar          emissores
   Sistema
                    utilizar os Emissores                                                        públicos-
Nacional NFS-e
                     Púbicos disponíveis                                                      nacionais (WEB,
                                                                                               Móvel e API)
                    Indicar qual será a fonte
                  das informações cadastrais
 Aderência a                                                                                 Definir a fonte de
                        dos contribuintes
 Módulos do                                                                                    informações
                   (CNC de responsabilidade     Checkbox       Obrig.        Selecionar
   Sistema                                                                                    cadastrais dos
                   de gestão dos municípios
Nacional NFS-e                                                                                 contribuintes
                               ou
                       CNPJ e CPF da RFB
                                                                                                Definir se o
 Aderência a
                    Indicar a utilização do                                                    município irá
 Módulos do
                     Módulo de Apuração         Checkbox       Obrig.        Selecionar      utilizar o Módulo
   Sistema
                       Nacional – MAN                                                          de Apuração
Nacional NFS-e
                                                                                             Nacional – MAN
                                                                                                Definir se o
     Permite                                                                                   município irá
aproveitamento                                                                                   permitir o
                      Indicar se haverá
  de Créditos                                                                                aproveitamento
                  aproveitamento de créditos    Checkbox       Obrig.        Selecionar
 disponíveis no                                                                                 de créditos
                          disponíveis
    Painel de                                                                                 disponíveis no
    Créditos                                                                                      Painel de
                                                                                                  Créditos
...
abaixo:
   ...
   •     É permitido cancelar uma NFS-e com tributos recolhidos?
    ...
    Campo                Descrição              Tipo    Funcionalidade             Ação
       Salvar       Salvar as informações de    Botão        Incluir        Efetivar a inclusão das
                     cancelamento de NFS-e                                      informações de
                            definidas                                      cancelamento de NFS-e
                                                                                    definidas
    Cancelar       Cancelar as informações de   Botão       Desfazer      Desfazer as informações de
                    cancelamento de NFS-e                                  cancelamento de NFS-e
                            definidas                                               definidas
...
São apresentadas as perguntas abaixo:
   ...
   Campo                  Descrição                 Tipo    Funcionalidade             Ação
       Salvar        Salvar as informações de       Botão        Incluir        Efetivar a inclusão das
                  substituição de NFS-e definidas                            informações de substituição
                                                                                  de NFS-e definidas
    Cancelar        Cancelar as informações de      Botão       Desfazer     Desfazer as informações de
                  substituição de NFS-e definidas                               substituição de NFS-e
                                                                                       definidas
...
seguir:
     ...
     Campo                    Descrição                  Tipo      Funcionalidade            Ação
   Seleção Atual         Serviço(s) para o qual(is)      Texto          Exibir                  -
                      está(ão) sendo definida(s) a(s)
                                 alíquota(s)
      Alíquota         Percentual da alíquota para o    Numérico       Incluir      Incluir o percentual para
                            serviço selecionado                                       o serviço selecionado
     Código de          Identificação do código de       Texto          Exibir                   -
  desdobramento                    serviço
 nacional vinculado
...
                                                                                             Manual de Integração
 ...
 Identificação no      Código numérico de 3 dígitos      Numérico       Incluir           Incluir um desdobro
 Sistema Nacional      utilizado para identificar este                                    municipal na lista de
                        serviço municipal dentro do                                       serviços do Sistema
                          Sistema Nacional. Não é                                               Nacional
                      permitido utilizar o código 000.
                          (Informação obrigatória)
 Código original do     Identificador original deste      Texto         Incluir           Incluir o identificador
     município        Código Municipal de Tributação                                              original
                                no município.
     Descrição             Descrição do código de         Texto         Incluir           Incluir a descrição do
                         desdobramento municipal.                                         Código de Tributação
                          (Informação obrigatória)                                               Municipal
     Cancelar              Cancelar o processo de         Botão        Desfazer          Desfazer o processo de
                       cadastramento do código de                                        cadastramento do novo
                               desdobramento                                            código de desdobramento
      Avançar             Redirecionar para tela de       Botão        Direcionar        Direcionar para tela de
                            definição de alíquota                                        definição de alíquota da
...
                                                                                         Manual de Integração
  ...
  Início da vigência    Início da vigência da alíquota    Data          Exibir                  -
       ...
       Salvar          Salvar informações de alíquota     Botão         Incluir      Efetivar a inclusão de
                                                                                            alíquota
      Cancelar             Cancelar o processo de         Botão       Desfazer      Desfazer o processo de
                            inclusão de alíquota                                      inclusão de alíquota
...
nos desdobros dos subitens da lista de serviços nacional.
     ...
     Campo                     Descrição                 Tipo     Funcionalidade            Ação
    Serviço(s)            Serviço(s) para o qual(is)     Texto         Exibir                   -
  Selecionado(s)       está(ão) sendo definida(s) a(s)
                                 redução(ões)
  O(s) serviço(s)      Pergunta para definir se haverá   Texto         Exibir                   -
   selecionado(s)        possibilidade de redução da
 permitem redução         base de cálculo do ISSQN.
 da base de cálculo
     do ISSQN?
     Sim / Não         Resposta Sim e Não disponíveis    Combo        Definir        Resposta Sim – abre
                               para marcação                                           opções de tipos de
                                                                                         redução de BC
Selecionar Tipos de     Combo com tipos de redução       Combo         Incluir       Incluir o(s) tipo(s) de
     Redução           de base de cálculos permitidas                                 redução marcada(s)
                              Valor Percentual;
                              Valor Monetário;
                              Por Documentos;
      Salvar           Salvar informações de redução     Botão         Incluir       Efetivar a inclusão de
                             de base de cálculo                                     tipos de redução de BC
     Cancelar              Cancelar o processo de        Botão        Desfazer      Desfazer o processo de
                            inclusão de redução                                       inclusão de tipos de
                                                                                         redução de BC
...
Segue abaixo a descrição dos campos.
  ...
  Código completo     Código completo do Código de       Texto       12             Obrigatório
     do serviço             Tributação Municipal
   Descrição do       Descrição completa do Código       Texto       500            Obrigatório
      serviço            de Tributação Municipal
 Código Original do   Código utilizado no município      Texto       50             Obrigatório
     Município         para identificar este mesmo
                                   serviço
  Identificador da         Identificador único da       Numérico     18             Obrigatório
     Legislação       legislação vinculada à criação
                                 do serviço
      Alíquota        Valor da alíquota definida para   Numérico      3             Obrigatório
                                  o serviço
 Dedução/Redução      Determina se o serviço admite     Numérico      1             Obrigatório
 - Valor monetário    ou não a dedução/redução da
                          Base de Cálculo do ISS
                        utilizando valor monetário
 Dedução/Redução      Determina se o serviço admite     Numérico      1             Obrigatório
 - Valor percentual   ou não a dedução/redução da
                          Base de Cálculo do ISS
                        utilizando valor percentual
 Dedução/Redução      Determina se o serviço admite     Numérico      1             Obrigatório
  - Documentos        ou não a dedução/redução da
                          Base de Cálculo do ISS
...
contribuinte, apenas aqueles já parametrizados no momento da adesão.
      ...
      Campo                  Descrição               Tipo      Funcionalidade             Ação
      CPF/CNPJ          CPF/CNPJ do contribuinte    Numérico       Incluir      Recuperar no Cadastro CPF
                             para inclusão                                      ou CNPJ o Nome ou Razão
                                                                                  Social do NI informado
  Nome/Razão Social        Nome/Razão Social         Texto          Exibir                   -
                           conforme cadastro
                                CPF/CNPJ
  Inscrição Municipal     Número da inscrição       Numérico       Incluir      Incluir a Inscrição Municipal
                        municipal do contribuinte                                         informada
    Data Inscrição       Data de inscrição como       Data         Incluir       Incluir a Data da inscrição
      Municipal         contribuinte no município                                   Municipal informada
         CEP                 Número do CEP          Número         Incluir       Recuperar as informações
                                                                                 de logradouro recuperadas
                                                                                 na tabela TOM com o CEP
                                                                                          informado
      Município          Nome do município ao        Texto          Exibir                     -
                            qual pertence o
                             contribuinte
     Logradouro           Nome do logradouro         Texto          Exibir                    -
       Bairro               Nome do bairro           Texto          Exibir                    -
...
                                                                                         Manual de Integração
    ...
    Complemento             Complemento do             Texto           Incluir      Incluir o complemento do
                                logradouro                                             logradouro informado
       Telefone            Número do telefone        Numérico          Incluir     Incluir o número do telefone
                        cadastrado como contato                                              do contato
                               no município
        E-mail             Endereço do e-mail       Endereço de        Incluir     Incluir o endereço de e-mail
                        cadastrado como contato       e-mail                                 do contato
                               no município
 Status para emissão     Indica se o contribuinte     Combo            Incluir         Incluir o status para
      de NFS-e           está habilitado ou não a                                       emissão de NFS-e
                               emitir NFS-e
       Situação           Situação cadastral do        Texto           Incluir      Incluir a situação cadastral
                               contribuinte.                                               do contribuinte
  Motivo da situação        Motivo da situação         Texto           Incluir     Incluir o motivo da situação
                        cadastral do contribuinte                                    cadastral do contribuinte
        Salvar          Salvar as informações do      Botão            Incluir         Efetivar a inclusão do
                         contribuinte cadastrado                                            contribuinte
       Cancelar          Cancelar o processo de       Botão           Desfazer        Desfazer o processo de
                            cadastramento do                                             cadastramento do
...
em uma tabela de Histórico.
      ...
      Campo                  Descrição                Tipo        Funcionalidade             Ação
      CPF/CNPJ          CPF/CNPJ do contribuinte     Numérico          Exibir                   -
                              para inclusão
  Nome/Razão Social        Nome/Razão Social           Texto           Exibir                   -
                           conforme cadastro
                                CPF/CNPJ
  Inscrição Municipal     Número da inscrição        Numérico         Alterar           Alterar a Inscrição
                        municipal do contribuinte                                            Municipal
    Data Inscrição       Data de inscrição como        Data           Alterar      Alterar a Data da inscrição
      Municipal         contribuinte no município                                            Municipal
         CEP                 Número do CEP           Número           Alterar       Recuperar para alteração
                                                                                        as informações de
                                                                                     logradouro recuperadas
                                                                                   na tabela TOM com o CEP
    ...
    Complemento             Complemento do             Texto          Alterar      Alterar o complemento do
       ...
       Telefone            Número do telefone        Numérico         Alterar         Alterar o número do
        ...
        E-mail             Endereço do e-mail       Endereço de       Alterar       Alterar o endereço de e-
                        cadastrado como contato       e-mail                             mail do contato
                              no município
       Situação           Situação cadastral do        Texto          Alterar          Alterar a situação
                              contribuinte.                                        cadastral do contribuinte
  Motivo da situação       Motivo da situação          Texto          Alterar         Alterar o motivo da
                        cadastral do contribuinte                                    situação cadastral do
                                                                                          contribuinte
 Status para emissão    Indica se o contribuinte      Combo           Alterar        Alterar o status para
      de NFS-e          está habilitado ou não a                                       emissão de NFS-e
                              emitir NFS-e
        Salvar           Salvar alterações das        Botão           Alterar        Efetivar a alteração do
...
                                                                                  Manual de Integração
    ...
    Ver Histórico      Visualizar alterações no    Botão        Exibir         Exibe o histórico de
                       cadastro do contribuinte                             alterações do cadastro do
                                                                                   contribuinte
      Cancelar          Cancelar o processo de     Botão       Desfazer      Desfazer o processo de
                       alteração do cadastro do                             alteração do cadastro do
                              contribuinte                                         contribuinte
...
contribuintes. As regras gerais estão descritas na página da funcionalidade.
   ...
   7. Para informações detalhadas, consulte o leiaute nas opções abaixo.
      ...
      Campo                 Descrição              Tipo    Funcionalidade            Ação
   Incluir Arquivo         Inicia processo de      Botão        Incluir        Validar e incluir as
                        validação e inclusão das                                informações dos
                            informações dos                                   contribuintes no CNC
                          contribuintes no CNC
  Selecionar arquivo      Permite selecionar o     Texto      Selecionar    Selecionar o arquivo para
                       endereço do arquivo para                                      upload
                       upload no computador do
                                 usuário
       Leiaute             Descreve todas as       Botão        Exibir                  -
                       informações que deverão
                           constar do arquivo
    Baixar arquivo     Faz download de planilha    Botão        Exibir                  -
       exemplo          com exemplo do arquivo
                                de upload
...
contribuinte.
    Campo                  Descrição                Tipo         Funcionalidade             Ação
    Serviço(s)        Serviço(s) para o qual(is)    Texto             Exibir                   -
  Selecionado(s)       está sendo definido os
                        Regimes Especiais de
                              Tributação
      Nome          Nome do Regime Especial de      Texto             Exibir                   -
                              Tributação
    ...
    Opção de          Combo para marcação da        Combo             Incluir     Efetivar a admissão ou não
    Admissão       admissão ou não admissão do                                        admissão do Regime
                         Regime Especial de                                          especial de tributação
                              Tributação
     Salvar            Salvar informações de        Botão             Incluir      Efetivar as informações de
                    Regimes Especiais admitidos                                        Regimes Especiais
                           e não admitidos                                         admitidos e não admitidos
    Cancelar       Cancelar o processo de incluir   Botão            Desfazer        Desfazer o processo de
                      informações de Regimes                                      inclusão de informações de
                      Especiais admitidos e não                                        Regimes Especiais
                              admitidos                                            admitidos e não admitidos
...
a caso refletindo a sua legislação local.
     ...
     Campo                    Descrição                  Tipo      Funcionalidade               Ação
     Descrição               Descrição da retenção       Texto          Incluir          Incluir a descrição da
                           municipal. (Informação                                         retenção municipal
                                  obrigatória)
    Legislação                Legislação municipal       Combo        Selecionar          Incluir a legislação
                           relacionada a retenção.                                      relacionada a retenção
                          (Informação obrigatória)
 Início da vigência     Data de início da vigência da     Data           Exibir                    -
                           legislação referenciada.
 Final da vigência      Data do final da vigência da      Data           Exibir                    -
                            legislação referenciada
    Vigência da         Data de início da vigência da     Data          Incluir        Incluir a data de vigência
retenção municipal          retenção. (Informação                                        da retenção definida
                                  obrigatória)
 Responsável (eis)    Determinar o responsável pela     Checkbox        Incluir        Incluir o responsável pela
 pela retenção do      retenção do ISSQN. (Tomador                                        retenção do ISSQN
      ISSQN           ou Intermediário). (Informação
                                  obrigatória)


     Campo                    Descrição                  Tipo      Funcionalidade               Ação
      Incluir         Botão para inclusão de serviço-    Botão          Incluir           Apresenta tela para
                       vinculado a retenção definida                                   inclusão de serviços a ser
     ...
     Reiniciar          Botão para reiniciar a tela      Botão          Reiniciar        Retorna a tela ao início
      Texto                Texto para pesquisa           Texto      Refinar pesquisa       Receber texto a ser
                                                                                               pesquisado
     Pesquisar        Pesquisa por código do serviço     Botão         Pesquisar       Recuperar as informações
                           ou nome do serviço                                          para a pesquisa solicitada


     Campo                     Descrição                 Tipo      Funcionalidade               Ação
      Incluir             Botão para inclusão de         Botão          Incluir           Apresenta tela para
                        responsável pela retenção                                       inclusão de responsável
                                 definida                                                pela retenção definida
     Reiniciar          Botão para reiniciar a tela      Botão          Reiniciar        Retorna a tela ao início
      Texto                Texto para pesquisa           Texto      Refinar pesquisa      Receber texto a ser
                                                                                               pesquisado
...
                                                                                            Manual de Integração
     ...
     Campo                    Descrição                 Tipo      Funcionalidade                Ação
       Salvar        Salvar informações de retenção      Botão          Incluir          Efetivar a inclusão das
                                de ISSQN                                                    informações para
                                                                                           retenção do ISSQN
      Cancelar           Cancelar o processo de          Botão         Desfazer         Desfazer o processo de
                     inclusão de retenção do ISSQN                                     inclusão das informações
...
é opcional para os municípios.
    ...
    Campo                   Descrição                  Tipo      Funcionalidade                Ação
  Novo Benefício     Botão para inclusão de novo       Botão          Incluir            Apresenta tela para
                              benefício                                                 inclusão de um novo
                                                                                              benefício
     Reiniciar        Botão para reiniciar a tela      Botão          Reiniciar        Retorna a tela ao início
      Texto              Texto para pesquisa           Texto      Refinar pesquisa       Receber texto a ser
                                                                                             pesquisado
    Pesquisar         Pesquisa pela descrição do       Botão         Pesquisar        Recuperar as informações
                              benefício                                               para a pesquisa solicitada

     Campo                      Descrição              Tipo       Funcionalidade                 Ação
    Descrição          Descrição do benefício da       Texto          Incluir           Incluir a descrição do
                           retenção municipal.                                          benefício da retenção
                       (Informação obrigatória)                                                municipal
    Legislação             Legislação municipal        Combo        Selecionar            Incluir a legislação
                      relacionada ao benefício da                                    relacionada ao benefício da
                         retenção. (Informação                                                 retenção
                               obrigatória)
Início da vigência   Data de início da vigência da      Data           Exibir                     -
                        legislação referenciada.
 Final da vigência   Data do final da vigência da       Data           Exibir                     -
                         legislação referenciada
   Vigência da       Data de início da vigência do      Data          Incluir         Incluir a data de vigência
    retenção              benefício da retenção.                                       do benefício da retenção
    municipal          (Informação obrigatória)                                                 definida
Tipo do Benefício      Definir qual benefício será    Checkbox        Incluir         Incluir o tipo de benefício
                                 permitido                                                    da retenção
                                     1.1.                                            2. ISSQN;
...
                                                                                     Manual de Integração
    ...
    Campo                Descrição                Tipo    Funcionalidade                Ação
     Incluir    Botão para inclusão de serviço-   Botão        Incluir           Apresenta tela para
                vinculado ao benefício definido                               inclusão de serviço a ser
    ...
    Campo                Descrição                Tipo    Funcionalidade                Ação
     Incluir        Botão para inclusão de        Botão        Incluir             Apresenta tela para
                         beneficiário                                           inclusão do beneficiário-
                                                                                        específico
    Reiniciar      Botão para reiniciar a tela    Botão        Reiniciar         Retorna a tela ao início
     Texto            Texto para pesquisa         Texto    Refinar pesquisa        Receber texto a ser
                                                                                       pesquisado
    Pesquisar        Pesquisa CNPJ ou CPF.        Botão       Pesquisar        Recuperar as informações
                                                                               para a pesquisa solicitada
...
Os campos envolvidos na alteração da alíquota são:
    ...
    Campo                    Descrição                   Tipo       Funcionalidade            Ação
 Item da Lei 116      Nome do serviço selecionado        Texto           Exibir                  -
   selecionado          para alteração da alíquota
     Alíquota        Alíquota que passará a vigorar    Percentual       Alterar      Alterar a alíquota vigente
Início da vigência   Data de início da vigência para      Data          Alterar      Alterar a data da vigência
                       a nova alíquota informada.
     Salvar             Salvar as informações de         Botão          Alterar       Efetivar as alterações de
                      alíquota e vigência alteradas                                     alíquotas e vigência
    Cancelar          Cancelar as informações de         Botão          Desfazer     Desfazer as informações de
                          alterações de alíquota                                      alterações de alíquota e
                                                                                               vigência
...
inconsistências.
   ...
   Campo                   Descrição                Tipo       Funcionalidade            Ação
       Serviço      Nome do serviço selecionado     Texto           Exibir                  -
                   para encerramento da alíquota
    Alíquota       Alíquota que passará a vigorar Percentual        Exibir                    -
 Fim da vigência   Data de final da vigência para    Data           Incluir        Incluir a data final da
                             a alíquota.                                            vigência da alíquota
    Motivo do       Motivo para o encerramento      Texto           Incluir       Incluir o motivo para o
  encerramento               da alíquota                                         encerramento da vigência
                                                                                         da alíquota
       Salvar        Salvar as informações de       Botão           Incluir     Efetivar o encerramento da
                     encerramento da alíquota                                       vigência da alíquota
    Cancelar        Cancelar as informações de      Botão          Desfazer     Desfazer as informações de
                     encerramento da alíquota                                    encerramento da alíquota
...
Os campos envolvidos na alteração da Dedução/Redução são:
 ...
 Selecionado(s)       está(ão) sendo definida(s) a(s)
  ...
  O(s) serviço(s)     Pergunta para definir se haverá    Texto          Exibir                  -
  selecionado(s)        possibilidade de redução da
    permitem             base de cálculo do ISSQN.
 redução da base
   de cálculo do
      ISSQN?
    Sim / Não         Resposta Sim e Não disponíveis     Combo         Definir        Resposta Sim – abre
                              para marcação                                        opções de tipos de redução
                                                                                        de base de cálculo
 Selecionar Tipos      Combo com tipos de redução        Combo         Incluir        Incluir o(s) tipo(s) de
   de Redução         de base de cálculos permitidas                                   redução marcada(s)
      Salvar          Salvar informações de redução      Botão         Incluir     Efetivar a inclusão de tipos
                            de base de cálculo                                       de redução de base de
                                                                                              cálculo
    Cancelar              Cancelar o processo de         Botão        Desfazer       Desfazer o processo de
                           inclusão de redução                                         inclusão de tipos de
...
Os campos envolvidos na alteração do Regime Especial de Tributação são:
     ...
     Campo                     Descrição                 Tipo     Funcionalidade             Ação
    Serviço(s)           Serviço(s) para o qual(is)      Texto          Exibir                  -
  Selecionado(s)       está(ão) sendo alterado(s) os
                          parâmetros de Regime
                           Especial de Tributação
 Regime Especial          Combo com os tipos de          Combo         Alterar     Selecionar o tipo de Regime
                             Regime Especial de                                     Especial de Tributação que
                           Tributação existentes                                          será alterado
  Nova Situação           Combo com os tipos de          Combo         Alterar     Selecionar a nova situação
                             situação existentes
 Início da Vigência      Início da vigência para as      Data          Alterar      Alterar a data de início da
                            alterações efetuadas                                   vigência para as alterações
                                                                                            efetuadas
     Motivo da             Motivo que pelo qual a        Texto         Alterar      Alterar o texto do motivo
     alteração            alteração está ocorrendo                                         da alteração
      Salvar               Salvar as alterações de       Botão         Alterar      Efetivar as alterações de
                           parâmetros de Regime                                      parâmetros de Regime
                           Especial de Tributação                                     Especial de Tributação
     Cancelar              Cancelar o processo de        Botão        Desfazer       Desfazer o processo de
                       alterar parâmetros de Regime                                 alterações de parâmetros
                           Especial de Tributação                                     de Regime Especial de
                                                                                            Tributação
...
Início da vigência    Início da vigência da retenção    Data          Exibir                     -
 Fim da vigência       Data de final da vigência da     Data          Incluir         Incluir a data final da
                                 retenção.                                            vigência da retenção
    Motivo da         Motivo para o encerramento da     Texto         Incluir        Incluir o motivo para o
    alteração                    retenção                                          encerramento da retenção
    Confirmar          Confirmar as informações de      Botão         Incluir      Efetivar o encerramento da
                        encerramento da retenção                                             retenção
    Cancelar           Cancelar as informações de       Botão        Desfazer      Desfazer as informações de
                        encerramento da retenção                                   encerramento da retenção
...
Início da vigência   Início da vigência do benefício   Data         Exibir                    -
 Fim da vigência      Data de final da vigência do     Data         Incluir        Incluir a data final da
                                benefício                                          vigência do benefício
   Motivo da         Motivo para o encerramento do     Texto        Incluir       Incluir o motivo para o
   alteração                    benefício                                       encerramento do benefício
   Confirmar          Confirmar as informações de      Botão        Incluir     Efetivar o encerramento do
                       encerramento da retenção                                           benefício
    Cancelar          Cancelar as informações de       Botão       Desfazer     Desfazer as informações de
                       encerramento do benefício                                encerramento do benefício
...
                                                                                                 Manual de Integração
     ...
     Campo                  Descrição           Tipo        Funcionalidade                       Ação
     CPF/CNPJ            CPF ou CNPJ do        Numérico            Pesquisar         Identificar no CNC o CPF/CNPJ
                            contribuinte                                                        informado
   Nome/Razão        Nome ou Razão Social        Texto             Pesquisar              Identificar no CNC o
      Social             do contribuinte                                             Nome/Razão Social informado
    Inscrição         Número da Inscrição      Numérico            Pesquisar        Identificar no CNC o número da
    Municipal                 Municipal                                              Inscrição Municipal informado
   Município/UF       Nome do Município e       Combo              Pesquisar              Identificar no CNC o
                             Sigla da UF                                                Município/UF informado
     Pesquisar             Pesquisa por          Botão             Pesquisar        Recuperar as informações para
                          parâmetro(s)                                                 parâmetro(s) informado(s)
                           informado(s)
     CPF/CNPJ            CPF ou CNPJ do        Numérico              Exibir                         -
                            contribuinte
   Nome/Razão        Nome ou Razão Social        Texto               Exibir                         -
     Social              do contribuinte
   Município/UF       Nome do Município e        Texto               Exibir                         -
                             Sigla da UF
  Emissão NFS-e       Indica se o município      Ícone               Exibir                         -
    ...
    Atualização          Data da última          Data                Exibir                         -
                         ...
                         informações do
                            contribuinte
 Ações no registro   Consultar informações       Botão             Consultar            Direcionar para efetuar a
                     detalhe ou histórico de                                              consulta selecionada
                          alterações de                                                         •   Detalhes
...
como segue abaixo:
        ...
        Campo                     Descrição                Tipo         Funcionalidade                  Ação
          CNPJ                 CNPJ do contribuinte        Texto               Exibir                     -
                                    selecionado
      Razão Social            Razão Social conforme        Texto               Exibir                     -
                                   cadastro CNPJ
   Inscrição Municipal         Número da inscrição        Numérico             Exibir                     -
                             municipal do contribuinte
 Data Inscrição Municipal     Data de inscrição como        Data               Exibir                     -
...
Segue abaixo as telas do gerenciamento do cadastro.
    ...
    Campo                   Descrição                  Tipo       Funcionalidade                  Ação
       Novo          Botão para inclusão de novo       Botão           Incluir        Apresenta tela para inclusão
                             contribuinte                                               de um novo contribuinte
     Reiniciar        Botão para reiniciar a tela      Botão           Reiniciar         Retorna a tela ao início
      Texto              Texto para pesquisa           Texto       Refinar pesquisa       Receber texto a ser
                                                                                              pesquisado
    Pesquisar         Pesquisa pelo CPF/CNPJ,          Botão          Pesquisar        Recuperar as informações
                       Nome/Razão Social, ou                                           para a pesquisa solicitada
                         Inscrição Municipal
    Atualização      Data da última atualização         Data            Exibir                       -
                         das informações do
                             contribuinte
     CPF/CNPJ       CPF ou CNPJ do contribuinte       Numérico          Exibir                       -
Inscrição Municipal     Número da Inscrição           Numérico          Exibir                       -
                               Municipal
    Nome/Razão       Nome ou Razão Social do           Texto            Exibir                       -
       Social                contribuinte
   Complemento            Complemento do               Texto            Exibir                       -
                              logradouro
      Telefone           Número do telefone           Numérico          Exibir                       -
                    cadastrado como contato no
                               município
       E-mail            Endereço do e-mail           Endereço          Exibir                       -
                    cadastrado como contato no        de e-mail
                               município
     Situação                                                           Exibir                       -
Motivo da Situação                                     Texto            Exibir                       -
    Status para       Indica se o contribuinte         Texto            Exibir                       -
 emissão de NFS-e     está habilitado ou não a
                            emitir NFS-e
  Limpar Pesquisa    Botão limpar pesquisa de          Botão           Limpar             Limpar o resultado da
                        Regimes Especiais de                                                    pesquisa
                              Tributação
       Texto             Texto para pesquisa           Texto       Refinar pesquisa        Receber texto a ser
                                                                                                pesquisado
    Pesquisar                 Pesquisa por             Botão          Pesquisar         Recuperar os dados para o
                     código/descrição do Regime                                        código/descrição de Regime
                         Especial de Tributação                                       Especial Tributário informado
      Voltar          Permite voltar a tela inicial    Botão            Voltar        Voltar a tela início de consulta
                          de consulta ao CNC                                                      ao CNC
  Nova Pesquisa                  PErmi
  Emissão NFS-e        Informa se o contribuinte       Ícone            Exibir                       -
                        está habilitado ou não a
                              emitir NFS-e
 Ações no registro          Editar/Consultar           Botão          Gerenciar        Direcionar para efetuar a
                        informações detalhe ou                                             opção selecionada
                      histórico de alterações de                                            •     Edição/Detalhes
                       informações e desabilitar                                                 •    Histórico
                           emissão de NFS-e                                           Desabilitar emissão de NFS-e
...
contribuinte, apenas aqueles já parametrizados no momento da adesão.
 ...
 Status para emissão     Indica se o contribuinte       Combo            Incluir            Incluir o status para
      de NFS-e           está habilitado ou não a                                            emissão de NFS-e
                               emitir NFS-e
  Situação Cadastral      Situação cadastral do          Texto           Incluir         Incluir a situação cadastral
                               contribuinte.                                                    do contribuinte
  Motivo da situação        Motivo da situação           Texto           Incluir        Incluir o motivo da situação
       cadastral        cadastral do contribuinte                                         cadastral do contribuinte
        Incluir         Botão para incluir Regime       Botão            Incluir        Apresenta tela para inclusão
                         Especiais de Tributação                                           de Regimes Especiais de
                                                                                                  Tributação
       Reiniciar        Botão para reiniciar a tela     Botão            Reiniciar          Retorna a tela ao início
        Texto              Texto para pesquisa          Texto        Refinar pesquisa        Receber texto a ser
                                                                                                  pesquisado
      Pesquisar          Pesquisa por código do         Botão           Pesquisar         Recuperar as informações
                           serviço ou nome do                                             para a pesquisa solicitada
                                 serviço
        Salvar          Salvar as informações do        Botão            Incluir           Efetivar a inclusão do
                         contribuinte cadastrado                                                contribuinte
       Cancelar          Cancelar o processo de         Botão           Desfazer          Desfazer o processo de
...
em uma tabela de Histórico.
  ...
  Nome/Razão Social        Nome/Razão Social             Texto            Exibir                     -
                            conforme cadastro
                                CPF/CNPJ
    Opção atual no      Informa se o contribuinte        Texto            Exibir                     -
   Simples Nacional      é optante pelo Simples
                                 Nacional
  Inscrição Municipal      Número da inscrição         Numérico          Alterar             Alterar a Inscrição
                        municipal do contribuinte                                                 Municipal
    Data Inscrição       Data de inscrição como          Data            Alterar        Alterar a Data da inscrição
    ...
    Complemento             Complemento do               Texto           Alterar        Alterar o complemento do
       ...
       Telefone            Número do telefone          Numérico          Alterar           Alterar o número do
        ...
        E-mail             Endereço do e-mail         Endereço de        Alterar         Alterar o endereço de e-
                        cadastrado como contato         e-mail                                mail do contato
                              no município
  Situação Cadastral      Situação cadastral do          Texto           Alterar            Alterar a situação
                              contribuinte.                                             cadastral do contribuinte
  Motivo da situação       Motivo da situação            Texto           Alterar           Alterar o motivo da
       cadastral        cadastral do contribuinte                                         situação cadastral do
                                                                                               contribuinte
 Status para emissão     Indica se o contribuinte       Combo            Alterar          Alterar o status para
      de NFS-e           está habilitado ou não a                                           emissão de NFS-e
                               emitir NFS-e
        Incluir         Botão para incluir Regime       Botão            Alterar           Apresenta tela para
                         Especiais de Tributação                                         alterar/incluir Regimes
...
dos filtros individualmente ou associados.
      ...
      Campo                 Descrição               Tipo      Funcionalidade            Ação
 Texto para pesquisa    Chave de acesso para        Texto         Pesquisar    Recuperar a NFS-e com a
                         pesquisa da NFS-e                                        chave de pesquisa
                                                                                      informada
      CPF/CNPJ         CPF ou CNPJ emissor da      Numérico       Pesquisar    Recuperar a NFS-e com o
                       NFS-e a ser recuperada                                        NI informado
   Tipo de Emissor     Selecionar qual o tipo de    Combo        Selecionar    Recuperar a NFS-e com o
                          emissor da NFS-e                                         tipo de emissor
                                                                                     selecionado
...
                                                                                          Manual de Integração
   ...
   Situação NFS-e       Selecionar o tipo de NFS-     Combo           Selecionar    Recuperar a NFS-e com a
                                    e                                                   situação da NFS-e
                                                                                            selecionada
  Inscrição Municipal     Número da Inscrição        Numérico          Pesquisar    Recuperar a NFS-e para a
                              Municipal                                                Inscrição Municipal
                                                                                             informada
         NIF             Número de Inscrição        Alfanumérico       Pesquisar     Recuperar a NFS-e com
                                Fiscal                                                    NIF informado
 Nome/Razão Social       Nome ou Razão Social          Texto           Pesquisar    Recuperar a NFS-e com o
                                                                                      Nome ou Razão Social
                                                                                             informado
     Valor Mínimo          Valor mínimo a ser          Valor           Pesquisar    Recuperar a NFS-e com o
                               considerado                                           valor mínimo informado
    Valor Máximo           Valor máximo a ser          Valor           Pesquisar    Recuperar a NFS-e com o
                               considerado                                          valor máximo informado
     Data inicial            Data inicial a ser        Data            Pesquisar    Recuperar a NFS-e com a
                            considerada como                                          data inicial informada
                            emissão da NFS-e
      Data Final             Data final a ser          Data            Pesquisar    Recuperar a NFS-e com a
                            considerada como                                            chave de pesquisa
                            emissão da NFS-e                                                informada
        Filtrar          Selecionar NFS-e pelos        Botão          Selecionar     Recuperar a(s) NFS-e(s)
                         parâmetros informados                                          pelos parâmetros
                                                                                          selecionados
       Reiniciar             Reiniciar a tela          Botão           Reiniciar    Retornar a tela a condição
                                                                                               inicial
       Emissão          Data da emissão da NFS-        Data             Exibir                    -
                                    e
       Emitente          CPF/CNPJ/Nome/Razão           Texto            Exibir                  -
                           Social do emitente
        Valor                Valor da NFS-e            Valor            Exibir                  -
      Situação             Situação da NFS-e           Texto            Exibir                  -
  Ações no registro       Ações sobre a NFSE           Botão          Selecionar    Direcionar para efetuar a
                                                                                        ação selecionada
                                                                                        •   Visualizar NFS-e
                                                                                        •   Cancelar por
                                                                                            Ofício
...
estão disponíveis somente no formato HTML (Transformação do XML com XSLT).
      ...
      Campo                   Descrição                Tipo        Funcionalidade            Ação
 Ícone para pesquisa       Retorna a tela de           Botão          Pesquisar       Retorna a página de
                            pesquisa inicial                                             pesquisa inicial
    Download XML        Gera download do NFS-e         Botão          Download      Faz o download da NFS-e
                            no formato XML                                               no formato XML
    Download PDF           Gera download do            Botão          Download         Faz o download do
                        DANFS-e no formato PDF                                        DANFSe da NFS-e no
                                                                                          formato PDF
   Chave de Acesso       Chave de acesso que         Numérico           Exibir                  -
                           identifica a NFS-e
   Data da Geração      Data e hora da geração       Data/Hora          Exibir                  -
                               da NFS-e
 ...
 Data da Emissão da     Data da emissão da DPS       Data/Hora          Exibir                  -
        DPS
   Versão da DPS            Versão da DPS            Numérico           Exibir                  -
 Nome/Razão Social      Nome ou Razão Social do       Texto             Exibir                  -
                               emitente
...
                                                                                  Manual de Integração
 ...
 Inscrição Municipal      Inscrição Estadual do       Numérico     Exibir               -
                                  emitente
  Situação perante o   Informa se o contribuinte       Texto       Exibir               -
   Simples Nacional     emitente é optante pelo
                             Simples Nacional
 Regime Especial de    Informa se o contribuinte       Texto       Exibir               -
       Tributação      possui Regime Especial de
                                 Tributação
     Município de        Nome do município de          Texto       Exibir               -
       Incidência          incidência do ISSQN
Exigibilidade do ISSQN Informa a exigibilidade ou      Texto       Exibir               -
                               não do ISSQN
     Competência       Informa a competência do         Data       Exibir               -
                                   ISSQN
   Valor do Serviço           Valor do serviço         Valor       Exibir               -
        Desconto             Valor do desconto         Valor       Exibir               -
    incondicionado            incondicionado
Desconto condicionado        Valor do desconto         Valor       Exibir               -
                               condicionado
  Dedução/Redução      Valor da dedução/redução        Valor       Exibir               -

   Base de cálculo       Valor para base de cálculo    Valor       Exibir               -
                                  do ISSQN
       Alíquota           Alíquota definida para o    Numérico     Exibir               -
                                    serviço
   Valor do ISSQN         Valor devido de ISSQN        Valor       Exibir               -
      Retenção               Informa se haverá         Texto       Exibir               -
                             retenção do ISSQN
    Valor líquido          Valor líquido da NFS-e      Valor       Exibir               -
 Versão da aplicação        Versão da aplicação        Texto       Exibir               -
  Ambiente Gerador         Ambiente gerador da         Texto       Exibir               -
                                    NFS-e
                              Aba Pessoas – Com Tomador Identificado
         CNPJ               CNPJ do tomador           Numérico     Exibir               -
  Inscrição Estadual      Inscrição Estadual do       Numérico     Exibir               -
                                 tomador
 Nome/Razão Social       Nome ou Razão Social do       Texto       Exibir               -
                                 tomador
       Telefone            Telefone de contato        Numérico     Exibir               -
        E-mail            Endereço de e-mail do        Texto       Exibir               -
                                 tomador
...
Código de Tributação    Código e descrição do          Texto       Exibir               -
      Nacional             serviço prestado
   Item da NBS               Item da NBS               Texto       Exibir               -
                      correspondente ao serviço
 Descrição do Serviço    Descrição do serviço          Texto       Exibir               -
                               prestado
Número do documento Número do documento de            Numérico     Exibir               -
 de responsabilidade   responsabilidade técnica
        técnica
   Documento de        Descrição do documento          Texto       Exibir               -
      referência             de referência
     Informações             Informações               Texto       Exibir               -
  complementares       complementares sobre o
                                serviço
                                             Aba Outros Tributos
Situação tributária do     Situação tributária do      Texto       Exibir               -
     PIS/COFINS                 PIS/COFINS
    Base de cálculo       Valor da base de cálculo     Valor       Exibir               -
     PIS/COFINS                  do tributo
...
PIS –Valor do imposto         Valor do imposto          Valor      Exibir               -
  ...
  COFINS –Valor do            Valor do imposto          Valor      Exibir               -
       imposto
...
                                                                               Manual de Integração
  ...
  Total de tributos    Total de tributos Federal    Valor   Exibir                   -
       Federal
  Total de tributos   Total de tributos Estadual    Valor   Exibir                   -
      Estadual
  Total de tributos   Total de tributos Municipal   Valor   Exibir                   -
      Municipal
...
                                                                                                 Manual de Orientações
    ...
    Segue abaixo uma tabela indicando quais atores devem ser distribuídos os DF-e:
                                                                                                   Emitente Não Emitente
                           Documentos Fiscais Eletrônicos – DF-e                                   da NFS-e   da NFS-e
NFS-e                                                                                                Não        Sim
