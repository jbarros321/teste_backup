...
public class RealizaMovimentosEstoque implements ScheduledAction {
                ...
                try {
                    ...
                    hnd.execWithTX(new JapeSession.TXBlock() {
                        ...
                        public void doWithTx() throws Exception {
                            inserirLog("[NOTA: " + nuNota + "] - Iniciando transação para registros de baixa e entrada",
                                    "S");
                            ...
                            try {
                                ...
                                if ("F".equals(tipMov) || "V".equals(tipMov)) {
                                    inserirLog("Processando retalho - TIPMOV: " + tipMov + " para nota: " + nuNota,
                                            "S");
                                ...
                                inserirLog("[NOTA: " + nuNota
                                        + "] -  Executando rollback - nenhuma alteração será gravada", "E");
                                System.out.println(
                                        "linha 111 Erro na transação para nota " + nuNota + ": " + e.getMessage());
                    ...
                    notasComErro++;
                    inserirLog("[NOTA: " + nuNota + "] -  TRANSAÇÃO CANCELADA - Todas as operações foram desfeitas",
                            "E");
    ...
    private BigDecimal geraBaixaRetalho(BigDecimal nuNota) throws Exception {
        ...
        try {
            ...
            try {
                ...
                sql.appendSql(
                        "SELECT ITE.CODEMP, ITE.CODPROD,ITE.QTDNEG,ITE.CODVOL,ITE.CODLOCALORIG,VOA.QUANTIDADE,PRO.AD_TIPRET,ITE.CONTROLE ");
                ...
                // sql.appendSql("ON VOA.CODPROD = ITE.CODPROD AND VOA.CODVOL = ITE.CODVOL AND
                // ITE.CONTROLE = VOA.CONTROLE ");
    ...
    private BigDecimal geraEntradaRetalho(BigDecimal nuNota) throws Exception {
        ...
        try {
            ...
            try {
                ...
                sql = new NativeSql(jdbc);
                sql.appendSql(
                        "SELECT ITE.CODEMP, ITE.CODPROD,ITE.QTDNEG,ITE.CODVOL,ITE.CODLOCALORIG,VOA.QUANTIDADE,PRO.AD_TIPRET ");
                sql.appendSql("FROM TGFITE ITE ");
                sql.appendSql("INNER JOIN TGFPRO PRO ");
                sql.appendSql("ON ITE.CODPROD = PRO.CODPROD ");
                sql.appendSql("INNER JOIN TGFVOA VOA ");
        ...
        try {
            ...
            for (DynamicVO ite : itens) {
                ...
                if (ite.asBigDecimalOrZero("AD_BO20000X1200").intValue() > 0) {
                    ...
                    // NOVO
                    itemVO.setProperty("VLRUNIT", ite.asBigDecimal("VLRTOT").divide(ite.asBigDecimal("AD_BO20000X1200"),
                ...
                if (ite.asBigDecimalOrZero("AD_BO20000X1400").intValue() > 0) {
                    ...
                    // NOVO
                    itemVO.setProperty("VLRUNIT", ite.asBigDecimal("VLRTOT").divide(ite.asBigDecimal("AD_BO20000X1400"),
                            2, RoundingMode.HALF_UP));
                    itemVO.setProperty("VLRDESC", new BigDecimal(0));
                    itemVO.setProperty("PERCDESC", new BigDecimal(0));
                ...
                if (ite.asBigDecimalOrZero("AD_BR6000").intValue() > 0) {
                    ...
                    itemVO.setProperty("VLRUNIT",
                            ite.asBigDecimal("VLRTOT").divide(ite.asBigDecimal("AD_BR6000"), 2, RoundingMode.HALF_UP));
                    itemVO.setProperty("VLRDESC", new BigDecimal(0));
                    itemVO.setProperty("PERCDESC", new BigDecimal(0));
                ...
                if (ite.asBigDecimalOrZero("AD_CH2000X1200").intValue() > 0) {
                    ...
                    // NOVO
                    itemVO.setProperty("VLRUNIT", ite.asBigDecimal("VLRTOT").divide(ite.asBigDecimal("AD_CH2000X1200"),
                ...
                if (ite.asBigDecimalOrZero("AD_CH2000X1500").intValue() > 0) {
                    ...
                    // NOVO
                    itemVO.setProperty("VLRUNIT", ite.asBigDecimal("VLRTOT").divide(ite.asBigDecimal("AD_CH2000X1500"),
                            2, RoundingMode.HALF_UP));
                    itemVO.setProperty("VLRDESC", new BigDecimal(0));
                    itemVO.setProperty("PERCDESC", new BigDecimal(0));
                ...
                if (ite.asBigDecimalOrZero("AD_CH3000X1200").intValue() > 0) {
                    ...
                    // NOVO
                    itemVO.setProperty("VLRUNIT", ite.asBigDecimal("VLRTOT").divide(ite.asBigDecimal("AD_CH3000X1200"),
                            2, RoundingMode.HALF_UP));
                    itemVO.setProperty("VLRDESC", new BigDecimal(0));
                    itemVO.setProperty("PERCDESC", new BigDecimal(0));
                ...
                if (ite.asBigDecimalOrZero("AD_CH3000X1500").intValue() > 0) {
                    ...
                    // NOVO
                    itemVO.setProperty("VLRUNIT", ite.asBigDecimal("VLRTOT").divide(ite.asBigDecimal("AD_CH3000X1500"),
                            2, RoundingMode.HALF_UP));
                    itemVO.setProperty("VLRDESC", new BigDecimal(0));
                    itemVO.setProperty("PERCDESC", new BigDecimal(0));
                ...
                if (ite.asBigDecimalOrZero("AD_CHRETALHO").intValue() > 0) {
                    ...
                    itemVO.setProperty("CODLOCALORIG", ite.getProperty("CODLOCALORIG"));
                    // NOVO
                    itemVO.setProperty("VLRUNIT", ite.asBigDecimal("VLRTOT").divide(ite.asBigDecimal("AD_CHRETALHO"), 2,
                            RoundingMode.HALF_UP));
                    itemVO.setProperty("VLRDESC", new BigDecimal(0));
                    itemVO.setProperty("PERCDESC", new BigDecimal(0));

                    if (estaNoIntervalo(ite.asBigDecimalOrZero("AD_CHRETALHO"), new BigDecimal(0),
                            new BigDecimal(0.75))) {
                        itemVO.setProperty("CONTROLE", "0x750Retalho");
                    } else if (estaNoIntervalo(ite.asBigDecimalOrZero("AD_CHRETALHO"), new BigDecimal(0.751),
                            new BigDecimal(1.5))) {
                        itemVO.setProperty("CONTROLE", "751x1500Retalho");
                    } else {
                        itemVO.setProperty("CONTROLE", ">1500Retalho");
                ...
                if (ite.asBigDecimalOrZero("AD_BRRETALHO").intValue() > 0) {
                    ...
                    // NOVO
                    itemVO.setProperty("VLRUNIT", ite.asBigDecimal("VLRTOT").divide(ite.asBigDecimal("AD_BRRETALHO"), 2,
                            RoundingMode.HALF_UP));
                    itemVO.setProperty("VLRDESC", new BigDecimal(0));
                    itemVO.setProperty("PERCDESC", new BigDecimal(0));
                    ...
                    if (estaNoIntervalo(ite.asBigDecimalOrZero("AD_CHRETALHO"), new BigDecimal(0),
                            new BigDecimal(0.5))) {
                        itemVO.setProperty("CONTROLE", "0x500Retalho");
                    } else if (estaNoIntervalo(ite.asBigDecimalOrZero("AD_CHRETALHO"), new BigDecimal(0.501),
                            new BigDecimal(1.5))) {
                        itemVO.setProperty("CONTROLE", "501x1500Retalho");
                    } else if (estaNoIntervalo(ite.asBigDecimalOrZero("AD_CHRETALHO"), new BigDecimal(1.501),
                            new BigDecimal(3))) {
                        itemVO.setProperty("CONTROLE", "1501x3000Retalho");
                    } else {
                        itemVO.setProperty("CONTROLE", ">3000Retalho");
                ...
                if (ite.asBigDecimalOrZero("AD_BORETALHO").intValue() > 0) {
                    ...
                    // NOVO
                    itemVO.setProperty("VLRUNIT", ite.asBigDecimal("VLRTOT").divide(ite.asBigDecimal("AD_BORETALHO"), 2,
                            RoundingMode.HALF_UP));
                    itemVO.setProperty("VLRDESC", new BigDecimal(0));
                    itemVO.setProperty("PERCDESC", new BigDecimal(0));

                    if (estaNoIntervalo(ite.asBigDecimalOrZero("AD_BORETALHO"), new BigDecimal(0),
                            new BigDecimal(0.5))) {
                        itemVO.setProperty("CONTROLE", "0x500Retalho");
                    } else if (estaNoIntervalo(ite.asBigDecimalOrZero("AD_BORETALHO"), new BigDecimal(0.501),
                            new BigDecimal(1))) {
                        itemVO.setProperty("CONTROLE", "501x1000Retalho");
                    } else if (estaNoIntervalo(ite.asBigDecimalOrZero("AD_BORETALHO"), new BigDecimal(1.001),
                            new BigDecimal(2))) {
                        itemVO.setProperty("CONTROLE", "1001x2000Retalho");
                    } else {
                        itemVO.setProperty("CONTROLE", ">2000Retalho");
    ...
    private void logarErroDetalhado(String operacao, BigDecimal nuNota, Exception e) {
        ...
        if (stack.length > 0) {
            inserirLog(notaInfo + " LOCAL: " + stack[0].getMethodName() + " (Linha " + stack[0].getLineNumber() + ")",
                    "E");
        }
