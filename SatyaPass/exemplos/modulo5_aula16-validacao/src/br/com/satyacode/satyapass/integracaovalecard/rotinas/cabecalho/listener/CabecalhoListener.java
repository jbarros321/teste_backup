package br.com.satyacode.satyapass.integracaovalecard.rotinas.cabecalho.listener;
...
public class CabecalhoListener implements EventoProgramavelJava {
    ...
    public void beforeUpdate(PersistenceEvent event) throws Exception {
        ...
        if((cabecalhoVO.asString("STATUS").equals("C") )){
            ModifingFields modifingFields = event.getModifingFields();
            if(!modifingFields.isModifing("STATUS")){
                throw new Exception("Ops! Não é possivel a edição de nenhum campo após a confirmação.");
            }
        }
