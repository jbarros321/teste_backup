    ...
    public void gerenciarDePara(BigDecimal nroUnico) throws Exception {
        ...
        if (!itensVO.isEmpty()){
            for (DynamicVO itemVO: itensVO){
                ...
                itemRepository.atualizarCamposNosItens(nroUnico,itemVO.asBigDecimal("SEQUENCIA"), "CODPROD", codProduto );
                itemRepository.atualizarCamposNosItens(nroUnico,itemVO.asBigDecimal("SEQUENCIA"), "CODVEICULO", codVeiculo );
            }
        }
