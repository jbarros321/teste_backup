...
public class ProcessarImportacaoBT implements AcaoRotinaJava {
    @Override
    public void doAction(ContextoAcao contexto) throws Exception {

        if (contexto.getLinhas().length == 0){
            throw new Exception("Selecione uma linha para poder realizar o processamento.");
        }
        for (Registro registro: contexto.getLinhas()){
            ...
            cabecalhoService.gerenciarProcessamento(nroUnico);
        }
