...
public class ItemRepository {
    ...
    public void atualizarCamposNosItens(BigDecimal nroUnico, BigDecimal sequencia,  String campo, Object valor) throws Exception {
        EntityFacade dwfFacade = EntityFacadeFactory.getDWFFacade();
    ...
    public void atualizarCamposNosItensTM(BigDecimal nroUnico, BigDecimal sequencia,  String campo, Object valor) throws MGEModelException {
        ...
        try {
            ...
            hnd.execWithTX(new JapeSession.TXBlock() {
                public void doWithTx() throws Exception {
                    atualizarCamposNosItens(nroUnico, sequencia, campo, valor);
                }
            });
        } catch (Exception e) {
