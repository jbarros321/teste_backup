package br.com.satyacode.satyapass.integracaovalecard.shared.utils;
...
public class ArquivoUtils {
    ...
    public static String getFileTypeByTika(InputStream inputStream) {
        Tika tika = new Tika();
        try {
            return tika.detect(inputStream);
        } catch (IOException e) {
            throw new RuntimeException("Erro ao detectar o tipo do arquivo", e);
        }
    }

    public static boolean isExcelMime(String tipo) {
        return tipo != null && (
                tipo.equals("application/vnd.ms-excel") ||
                        tipo.equals("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet") ||
                        tipo.equals("application/x-tika-msoffice") ||
                        tipo.equals("application/x-tika-ooxml")
        );
    }
