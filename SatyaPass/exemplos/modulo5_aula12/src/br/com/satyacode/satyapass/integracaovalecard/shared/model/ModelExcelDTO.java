package br.com.satyacode.satyapass.integracaovalecard.shared.model;
...
public class ModelExcelDTO {
    ...
    public static class ColunaExcel {
        ...
        public EnumTipoColuna getTipoColuna() {
            return tipoColuna;
        }

        public void setTipoColuna(EnumTipoColuna tipoColuna) {
            this.tipoColuna = tipoColuna;
        }
    ...
    public enum EnumTipoColuna {
        ...
        static {
            for (EnumTipoColuna enumTipoNotificacao : EnumTipoColuna.values()) {
                funcaoPorValor.put(enumTipoNotificacao.getValor(), enumTipoNotificacao);
            }
        }
    }
    ...
    public static class ValidaColuna {
        ...
        public ValidaColuna(ColunaExcel coluna) {
            this.coluna = coluna;
        }

        public ValidaColuna(boolean isAcionado) {
        ...
        public String getColunaRecebida() {
            return colunaRecebida;
        }

        public void setColunaRecebida(String colunaRecebida) {
            this.colunaRecebida = colunaRecebida;
        }

        public ColunaExcel getColuna() {
            return coluna;
        }

        public void setColuna(ColunaExcel coluna) {
            this.coluna = coluna;
        }
