                        ...
                        <head>
                            ...
                            <style>
                                :root {
                                    ...
                                    --ok: #16a34a;
                                    --info: #2563eb;
                                    /* saldo/folga: azul, nao verde nem vermelho */
                                    --warn: #d97706;
                                    --danger: #dc2626;
                                }
                                ...
                                * {
                                ...
                                /* Cada opção tem duas linhas: descrição em cima e o código do
                                   registro como sublegenda, porque descrições iguais aparecem em
                                   códigos diferentes (naturezas, CR e projetos). */
                                .ms-option {
                                    display: flex;
                                            ...
                                            <%-- Lógica em JavaScript puro: usa CONCATENAÇÃO de string (nunca template
                                                ...
                                                <script>
                                                    document.addEventListener('DOMContentLoaded', function () {
                                                        ...
                                                        // Saldo/folga SEMPRE = realizado - orcado, com os valores no sinal da
                                                        // carga (receita +, despesa -). Assim orcado -2.000 com realizado -500
                                                        // da +1.500 de folga, e nao -1.500 de estouro. Positivo = sobrou
                                                        // orcamento (ou receita acima da meta) e sai em AZUL; negativo = estouro.
                                                        function saldoDe(orc, real) { return real - orc; }
                                                        function classeSaldo(v) { return v > 0 ? 'val-saldo' : (v < 0 ? 'val-neg' : ''); }
                                                        ...
                                                        // Descricao vem do banco e pode ter & < > ou aspas: escapar antes de
                                                        // montar o HTML da opcao, senao uma aspa quebra o data-search/title.
                                                        function _escHtml(v) {
                                                            return String(v == null ? '' : v)
                                                                .replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;');
                                                        }
                                                        function _escAttr(v) {
                                                            return _escHtml(v).replace(/"/g, '&quot;');
                                                        }
                                                        ...
                                                        MultiSelect.prototype.setItems = function (items, keepSelection) {
                                                            ...
                                                            if (!items.length) {
                                                                ...
                                                                items.forEach(function (item) {
                                                                    ...
                                                                    var desc = String(item[1] || val);
                                                                    // A busca casa tanto pela descricao quanto pelo codigo.
                                                                    var busca = (desc + ' ' + val).toLowerCase();
                                                                    html += '<div class="ms-option' + (isSel ? ' selected' : '') + '" data-value="' + _escAttr(val) + '" data-search="' + _escAttr(busca) + '" title="' + _escAttr(val + ' - ' + desc) + '">' +
                                                                        '<span class="ms-checkbox">✔</span>' +
                                                                        '<span class="ms-option-txt">' +
                                                                        '<span class="ms-option-label">' + _escHtml(desc) + '</span>' +
                                                                        '<span class="ms-option-cod">Cód. ' + _escHtml(val) + '</span>' +
                                                                        '</span>' +
                                                                        '</div>';
                                                                });
                                                            }
                                                        ...
                                                        MultiSelect.prototype._updateTrigger = function () {
                                                            ...
                                                            if (count === 0) {
                                                                ...
                                                                // Com 1 marcado cabe "codigo - descricao"; com varios, a lista
                                                                // completa vai para o title (tooltip) do gatilho.
                                                                var sels = [], first = '';
                                                                for (var i = 0; i < this.items.length; i++) {
                                                                    var v = String(this.items[i][0]);
                                                                    if (!this.selected[v]) continue;
                                                                    var par = v + ' - ' + (this.items[i][1] || v);
                                                                    if (!first) first = par;
                                                                    sels.push(par);
                                                                }
                                                            ...
                                                            if (this.triggerEl) this.triggerEl.title = titulo;
                                                        };

                                                        // ─── Utilitários de filtro ────────────────────────────────
                                                        var EMPRESAS_EXCLUIDAS = ['999', '103', '777', '666', '555', '108', '109'];

                                                        // O filtro de Natureza lista so as folhas (ANALITICA='S' na TGFNAT):
                                                        // natureza sintetica e agrupador da arvore do DRE, nao tem lancamento
                                                        // proprio. Codigo que nao esta na arvore (ex.: fora da faixa carregada)
                                                        // continua aparecendo, para nao sumir com dado do RAW.
                                                        var _MAPA_ANALITICA = null;
                                                        function ehNaturezaAnalitica(cod) {
                                                            if (_MAPA_ANALITICA === null) {
                                                                _MAPA_ANALITICA = {};
                                                                (window.ARVORE_NAT || []).forEach(function (n) {
                                                                    _MAPA_ANALITICA[String(n.CODNAT)] = (n.ANALITICA === 'S');
                                                                });
                                                            }
                                                            var v = _MAPA_ANALITICA[String(cod)];
                                                        ...
                                                        function atualizarItensFiltros() {
                                                            ...
                                                            if (msNat) msNat.setItems(distinct('CODNAT', 'NATUREZA_NOME', function (r) {
                                                                return ehNaturezaAnalitica(r.CODNAT);
                                                            }), true);
                                                        ...
                                                        function render() {
                                                            ...
                                                            var saldo = saldoDe(totOrc, totReal);
                                                            ...
                                                            el('hero-d-legenda').innerHTML =
                                                                ...
                                                                ' &bull; Saldo <b style="color:' + (dSaldo >= 0 ? '#bfdbfe' : '#fecaca') + '">' + fmtBRL(dSaldo) + '</b>';
                                                            ...
                                                            el('hero-r-legenda').innerHTML =
                                                                ...
                                                                ' &bull; ' + (rSuper >= 0 ? 'Superávit' : 'Défice') + ' <b style="color:' + (rSuper >= 0 ? '#bfdbfe' : '#fecaca') + '">' + fmtBRL(rSuper) + '</b>';
                                                            ...
                                                            el('kpis').innerHTML =
                                                                ...
                                                                kpi(visReceita ? 'Superávit de receita' : 'Saldo orçamentário', fmtBRL(saldo),
                                                                    saldo >= 0 ? (visReceita ? 'Acima da meta' : 'Dentro do orçado') : (visReceita ? 'Abaixo da meta' : 'Estourado'),
                                                                    saldo >= 0 ? 'info' : 'danger') +
                                                                ...
                                                                kpi('Desvio vs Orçado', fmtBRL(desvioForecast),
                                                                    desvioForecast === 0 ? 'Sem desvio' : (desvioForecast > 0 ? 'Melhor que o orçado' : 'Pior que o orçado'),
                                                                    desvioForecast === 0 ? '' : (desvioForecast > 0 ? 'info' : 'danger')) +
                                                        ...
                                                        function renderResumo(linhas, porMes, corte) {
                                                            ...
                                                            for (var m = 1; m <= 12; m++) {
                                                                ...
                                                                var saldo = saldoDe(d.orc, d.real);
                                                                ...
                                                                html +=
                                                                    ...
                                                                    '<td class="' + classeSaldo(saldo) + '">' + (m <= corte ? fmtBRL(saldo) : '—') + '</td>' +
                                                                    '<td>' + fmtBRL(accOrc) + '</td>' +
                                                            ...
                                                            html +=
                                                                ...
                                                                '<td class="' + classeSaldo(saldoDe(totOrc, totReal)) + '">' + fmtBRL(saldoDe(totOrc, totReal)) + '</td>' +
                                                                '<td>' + fmtBRL(accOrc) + '</td>' +
                                                        ...
                                                        function renderTabela(linhas) {
                                                            ...
                                                            function renderNode(node, parentId) {
                                                                ...
                                                                var saldo = saldoDe(node.orc, node.real);
                                                                ...
                                                                html +=
                                                                    ...
                                                                    '<td class="' + classeSaldo(saldo) + '">' + fmtBRL(saldo) + '</td>' +
                                                                ...
                                                                if (hasDetalhes) {
                                                                    detArr.forEach(function (f) {
                                                                        ...
                                                                        html +=
                                                                            ...
                                                                            '<td>' + fmtBRL(f.orc) + '</td>' +
                                                                            '<td>' + fmtBRL(f.real) + '</td>' +
                                                                            '<td class="' + classeSaldo(s2) + '">' + fmtBRL(s2) + '</td>' +
                                                            ...
                                                            // Total geral
                                                            var saldoT = saldoDe(totOrc, totReal);
                                                            var pctT = totOrc !== 0 ? (totReal / totOrc) * 100 : 0;
                                                            html +=
                                                                '<tr class="row-total">' +
                                                                '<td>TOTAL GERAL</td>' +
                                                                '<td>' + fmtBRL(totOrc) + '</td>' +
                                                                '<td>' + fmtBRL(totReal) + '</td>' +
                                                                '<td class="' + classeSaldo(saldoT) + '">' + fmtBRL(saldoT) + '</td>' +
                                                                '<td>' + fmtPct(pctT) + '</td>' +
                                                                '</tr>';
                                                            ...
                                                            try {
                                                                ...
                                                                for (var m = 1; m <= 12; m++) {
                                                                    ...
                                                                    resumoData.push({
                                                                        ...
                                                                        'Saldo': m <= corte ? saldoDe(d.orc, d.real) : null,
                                                                        'Orçado Acum.': accOrc,
                                                                ...
                                                                var natData = Object.keys(porNat).map(function (k) {
                                                                    ...
                                                                    return {
                                                                        ...
                                                                        Orcado: n.Orcado, Realizado: n.Realizado, Saldo: saldoDe(n.Orcado, n.Realizado),
                                                                ...
                                                                var detData = linhas.map(function (r) {
                                                                    ...
                                                                    return {
                                                                        ...
                                                                        'Orçado': v.orc, 'Realizado': v.real, 'Saldo': saldoDe(v.orc, v.real)
                                                                    };
                                                                });
