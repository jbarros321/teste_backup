<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" isELIgnored="true" %>
    <<<<<<< HEAD <%@ taglib prefix="snk" uri="/WEB-INF/tld/sankhyaUtil.tld" %>
        <%-- mitralab.jsp - casca (shell) para rodar um projeto MitraLab dentro do Sankhya. A tela do Sankhya carrega
            ...
            <% /*==================CONFIGURACAO==================Troque APENAS a URL abaixo pela URL do projeto
                ...
                TITULO="MitraLab" ; boolean BARRA=true; /* barra superior com titulo, usuario e recarregar */ boolean
                PASSA_QS=true; /* repassa a query string desta tela para o iframe */=======<%@ taglib prefix="snk"
                uri="/WEB-INF/tld/sankhyaUtil.tld" %>
                <%-- mitralab.jsp - casca (shell) para rodar um projeto MitraLab dentro do Sankhya. A tela do Sankhya
                    carrega este JSP; o projeto real roda dentro do iframe abaixo. Configuracao: bloco no inicio do
                    scriptlet (URL, titulo, barra, query string). --%>
                    <% /*==================CONFIGURACAO==================Troque APENAS a URL abaixo pela URL do projeto
                        MitraLab. Precisa ser HTTPS se o Sankhya roda em HTTPS (senao o navegador bloqueia o conteudo
                        misto e o iframe fica em branco). */ String URL_APP="https://19825-57477.prod.mitralab.io" ;
                        String TITULO="MitraLab" ; boolean BARRA=true; /* barra superior com recarregar / abrir em nova
                        aba */ boolean PASSA_QS=true; /* repassa a query string desta tela para o iframe */ /* Usuario
                        logado do Sankhya (STP_GET_CODUSULOGADO). PASSA_USUARIO=true -> a tela consulta quem esta logado
                        e acrescenta os
                                            ...
                                            <div id="wrap">
                                                <% if (BARRA) { %>
                                                    <div id="barra">
                                                        ...
                                                        <span class="usuario" id="usuario"
                                                            title="Usuario logado no Sankhya"></span>
                                                        <button type="button" onclick="recarregar()">Recarregar</button>
                                                    </div>
                                                    <% } %>
                                                        =======
                                                        <div id="palco">
                                                            ...
                                                            <div id="erro" class="camada oculto">
                                                                ...
                                                                <div>O site pode estar fora do ar ou pode estar
                                                                    bloqueando a exibicao em
                                                                    iframe (cabecalhos X-Frame-Options /
                                                                    Content-Security-Policy).</div>
                                                                <div class="cod" id="urlErro"></div>
                                                                <div class="acoes">
                                                                    <a id="linkNova" href="#" target="_blank"
                                                                        rel="noopener">Abrir em nova
                                                                        aba</a>
                                                                    <button type="button" class="sec"
                                                                        onclick="recarregar()">Tentar de
                                                                        novo</button>
                                                                </div>
                                                            </div>
                                                        </div>
