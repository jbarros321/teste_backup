                                ...
                                AND RECDESP <> 0
                                    ...
                                    WHERE CAB.STATUSNOTA = 'L' AND CAB.TIPMOV IN ('V', 'D') AND ITE.USOPROD <> 'D'
                                        ...
                                        WHERE CAB.STATUSNOTA = 'L' AND CAB.TIPMOV IN ('V', 'D') AND ITE.USOPROD <> 'D'
                                            ...
                                            AND Q.DTREF < DATE '2027-01-01' AND (Q.CODEMP IS NULL OR Q.CODEMP NOT IN
                                                (999, 103, 777, 666, 555, 108, 109)) GROUP BY TO_CHAR(Q.DTREF, 'YYYY-MM'
                                                ...
                                                <%-- Hierarquia completa de naturezas para montar a árvore DRE --%>
                                                    ...
                                                    <body>
                                                            ...
                                                            <div class="topbar">
                                                                ...
                                                                <div class="filtros">
                                                                    <div class="filtro-item"><label>Data
                                                                            inicial</label><input type="date"
                                                                            id="f-dt-de" class="filtro" min="2026-01-01"
                                                                            max="2026-12-31"></div>
                                                                    <div class="filtro-item"><label>Data
                                                                            final</label><input type="date"
                                                                            id="f-dt-ate" class="filtro"
                                                        ...
                                                        <div id="modal-titulos-container" class="modal-backdrop"
                                                            style="display:none;">
                                                            <div class="modal-box" style="max-width:1200px;">
                                                                ...
                                                                <div id="modal-toolbar"
                                                                    ...
                                                                    <input type="text" id="modal-titulos-search"
                                                        ...
                                                        <%-- Dados serializados para JSON (EL do servidor só é usado
                                                            aqui) --%>
                                                            <script>
                                                            ...
                                                            <%-- Árvore de naturezas para o DRE hierárquico --%>
                                                                ...
                                                                <%--============================================================MATRIZ
                                                                    DRE – REGRAS (origem + sinal por Natureza)
                                                                    Referência: "REGRAS – DRE GERENCIAL" / planilha
                                                                    MATRIZ DRE. Origem: PV=Portal de Vendas | PC=Portal
                                                                    de Compras CTB=Contabilidade | FIN=Movimentação
                                                                    Financeira CUS=Customização | NU=Não Utilizado Sinal
                                                                    : P=Positivo | N=Negativo DC=Débito Negativo /
                                                                    Crédito Positivo Natureza fora desta matriz=>
                                                                    INCONSISTÊNCIA (não inferir).
                                                                    ============================================================
                                                                    --%>
                                                                    <script>
                                                                        window.DRE_REGRAS = (function () {
                                                                            var M = {};
                                                                            function add(origem, sinal, ids) {
                                                                                for (var i = 0; i < ids.length; i++) M[String(ids[i])] = { o: origem, s: sinal };
                                                                            }
                                                                            ...
                                                                            add('FIN', 'P', [1010302, 1010401, 1010402, 1010499, 1020105, 5020101, 5020102, 5020103]);
                                                                            add('FIN', 'N', [1020204, 4030704, 5020201, 5020202, 5020205, 5020206]);

                                                                            add('CUS', 'N', [2010101, 2010301, 2010401]);

                                                                            add('NU', '', [1010301, 7010212]);

                                                                            add('CTB', 'DC', [
                                                                                1010202, 1020104, 1020399,
                                                                                2010299, 2010302, 2010402,
                                                                                3010101, 3010104, 3010201, 3010202, 3010204, 3010205, 3010206, 3010207, 3010208, 3010209, 3010307,
                                                                                3020202,
                                                                                4010101, 4010102, 4010103, 4010104, 4010105, 4010106, 4010107, 4010108, 4010109,
                                                                                4010201, 4010202, 4010203, 4010204, 4010205, 4010206, 4010207, 4010208, 4010209, 4010210, 4010211, 4010212, 4010213,
                                                                                4010301,
                                                                                4030699, 4030701, 4030702, 4030703, 4030706, 4030707, 4030708,
                                                                                4040101, 4040201, 4040301, 4040302, 4040303, 4040401, 4040402,
                                                                                5010101, 5010102, 5020104, 5020105, 5020106, 5020203, 5020204, 5020207,
                                                                                6010101, 6010102, 6010103, 6010104, 6010105, 6010106,
                                                                                7010204, 7020102, 7020204
                                                                            ]);

                                                                            add('PC', 'N', [
                                                                                2010201, 2010202, 2010405, 2010407,
                                                                                3020101, 3020104, 3020106,
                                                                                4010110,
                                                                                4010302, 4010303, 4010304, 4010305, 4010306, 4010307, 4010308, 4010309, 4010310, 4010399,
                                                                                4020101, 4020102, 4020103, 4020104, 4020105, 4020106, 4020107, 4020108, 4020109, 4020110, 4020199,
                                                                                4030101, 4030102, 4030103, 4030199,
                                                                                4030201, 4030202, 4030203, 4030204, 4030205, 4030206, 4030299,
                                                                                4030301, 4030302, 4030303, 4030304, 4030305, 4030306, 4030307, 4030308, 4030309, 4030310,
                                                                                4030311, 4030312, 4030313, 4030314, 4030315, 4030316, 4030317, 4030318, 4030319, 4030320,
                                                                                4030321, 4030322, 4030323, 4030399,
                                                                                4030401, 4030402,
                                                                                4030501, 4030502, 4030503, 4030504, 4030505, 4030506, 4030507, 4030508, 4030599,
                                                                                4030601, 4030602, 4030603, 4030604,
                                                                                4030705,
                                                                                4040202, 4040203,
                                                                                7010101, 7010102, 7010103, 7010199,
                                                                                7010201, 7010202, 7010203, 7010205, 7010206, 7010207, 7010208, 7010209, 7010210, 7010211, 7010299,
                                                                                7020101, 7020103,
                                                                                7020201, 7020202, 7020203, 7020205, 7020206
                                                                            ]);

                                                                            return M;
                                                                        })();

                                                                        // Parametros gerais das regras (item 1 da especificacao).
                                                                        // Os nomes de coluna/funcao NAO sao fixados aqui: o componente
                                                                        // consulta o dicionario do banco (_carregarCapacidades) e usa
                                                                        // o primeiro candidato que existir de fato.
                                                                        window.DRE_CFG = {
                                                                            EMPRESAS: [1, 2, 3, 4, 5, 6],
                                                                            CR_INTERCOMPANY: '103040',
                                                                            CODNAT_COMISSAO: 2010401,
                                                                            CODNAT_DIRAUT: 2010301,
                                                                            // Tributos sobre receita:
                                                                            //   ISS  -> campo nativo da propria nota (TGFCAB)
                                                                            //   PIS  -> TGFDIN, CODIMP = 6
                                                                            //   COFINS -> TGFDIN, CODIMP = 7
                                                                            TRIBUTOS_NOTA: {
                                                                                '1020301': { fonte: 'CAB', desc: 'ISS' },
                                                                                '1020302': { fonte: 'DIN', cods: [6], desc: 'PIS' },
                                                                                '1020303': { fonte: 'DIN', cods: [7], desc: 'COFINS' }
                                                                            }
                                                                        };
                                                                    </script>

                                                                    <%-- Lógica em JavaScript puro: usa CONCATENAÇÃO de
                                                                        string (nunca template literals), para não
                                                                        colidir com a sintaxe ${...} do EL do JSP. --%>
                                                                        <script>
                                                                            document.addEventListener('DOMContentLoaded', function () {
                                                                                ...
                                                                                // Todo campo que o componente usa em SQL fixo (isto e, que NAO
                                                                                // passa por _colDe) esta declarado aqui. Antes de montar qualquer
                                                                                // consulta, conferimos contra ALL_TAB_COLUMNS e reportamos o que
                                                                                // nao existe, em vez de deixar o Oracle devolver ORA-00904.
                                                                                var _ESQUEMA_USADO = {
                                                                                    TCBLAN: ['CODCTACTB', 'VLRLANC', 'TIPLANC', 'REFERENCIA', 'NUMDOC', 'NUMLANC', 'COMPLHIST', 'CODEMP', 'CODPROJ', 'CODCENCUS'],
                                                                                    TGFNAT: ['CODNAT', 'DESCRNAT', 'CODNATPAI', 'TIPNAT', 'ANALITICA', 'CODCTACTB', 'CODCTACTB2'],
                                                                                    TGFFIN: ['NUFIN', 'NUNOTA', 'NUMNOTA', 'DTNEG', 'VLRDESDOB', 'CODNAT', 'CODEMP', 'CODPROJ', 'CODCENCUS', 'PROVISAO', 'CODTIPOPER'],
                                                                                    TGFCAB: ['NUNOTA', 'NUMNOTA', 'DTNEG', 'VLRNOTA', 'VLRISS', 'CODNAT', 'CODEMP', 'CODPROJ', 'CODCENCUS', 'TIPMOV', 'STATUSNOTA', 'CODTIPOPER', 'DHTIPOPER', 'RATEADO', 'CODPARC'],
                                                                                    TGFTOP: ['CODTIPOPER', 'DHALTER', 'ATIVO', 'ATUALCTB', 'ATUALCOM'],
                                                                                    TGFDIN: ['NUNOTA', 'CODIMP', 'VALOR'],
                                                                                    TGFCOM: ['NUNOTAORIG', 'VLRCOM', 'CODFORM'],
                                                                                    TGFITE: ['NUNOTA', 'CODPROD', 'VLRUNIT', 'QTDNEG', 'USOPROD'],
                                                                                    TGFPAR: ['CODPARC'],
                                                                                    TSIEMP: ['CODEMP', 'NOMEFANTASIA'],
                                                                                    TCSPRJ: ['CODPROJ', 'IDENTIFICACAO'],
                                                                                    TSICUS: ['CODCENCUS', 'DESCRCENCUS', 'CODUSURESP'],
                                                                                    TSIUSU: ['CODUSU', 'NOMEUSU']
                                                                                };

                                                                                var _faltantes = null;

                                                                                // Confere o esquema declarado acima contra o dicionario do banco.
                                                                                async function _conferirEsquema() {
                                                                                    if (_faltantes) return _faltantes;
                                                                                    var tabs = Object.keys(_ESQUEMA_USADO);
                                                                                    var cond = tabs.map(function (t) {
                                                                                        return "(TABLE_NAME='" + t + "' AND COLUMN_NAME IN ('" + _ESQUEMA_USADO[t].join("','") + "'))";
                                                                                    }).join(' OR ');
                                                                                    var res = await _dbQuery("SELECT TABLE_NAME||'.'||COLUMN_NAME AS ITEM FROM ALL_TAB_COLUMNS WHERE " + cond);

                                                                                    var existe = {};
                                                                                    (res.data || []).forEach(function (r) { existe[String(r[0]).toUpperCase()] = true; });

                                                                                    _faltantes = [];
                                                                                    tabs.forEach(function (t) {
                                                                                        _ESQUEMA_USADO[t].forEach(function (c) {
                                                                                            if (!existe[t + '.' + c]) _faltantes.push(t + '.' + c);
                                                                                        });
                                                                                    });

                                                                                    if (_faltantes.length) {
                                                                                        console.warn('[DRE] CAMPOS INEXISTENTES NO BANCO (corrigir no componente):', _faltantes);
                                                                                    } else {
                                                                                        console.log('[DRE] esquema conferido: todos os campos usados existem no banco.');
                                                                                    }
                                                                                    return _faltantes;
                                                                                }

                                                                                // ─── Capacidades do banco ─────────────────────────────────
                                                                                // Nomes de coluna/funcao variam entre versoes e customizacoes
                                                                                // do Sankhya. Em vez de fixar, perguntamos ao dicionario uma
                                                                                // unica vez e montamos o SQL com o que existe de fato.
                                                                                var _cap = null;

                                                                                var _CAND = {
                                                                                    'TCBLAN.DEBCRED': ['TIPLANC'],
                                                                                    'TGFTOP.CTB': ['ATUALCTB'],
                                                                                    'TGFDIN.COD': ['CODIMP'],
                                                                                    'TGFDIN.VLR': ['VALOR'],
                                                                                    'TGFCAB.ISS': ['VLRISS']
                                                                                ...
                                                                                async function _carregarCapacidades() {
                                                                                    if (_cap) return _cap;
                                                                                    var alvos = [
                                                                                        ["TGFCAB", _CAND['TGFCAB.ISS'].concat(['RATEADO', 'STATUSNOTA', 'DHTIPOPER', 'OBSERVACAO'])],
                                                                                        ["TCBLAN", _CAND['TCBLAN.DEBCRED'].concat(['REFERENCIA', 'NUMDOC', 'NUMLANC', 'COMPLHIST'])],
                                                                                        ["TGFTOP", _CAND['TGFTOP.CTB'].concat(['ATIVO', 'DHALTER'])],
                                                                                        ["TGFNAT", ['CODCTACTB', 'CODCTACTB2']],
                                                                                        ["TGFFIN", ['CODTIPOPER', 'VLRDESDOB', 'PROVISAO', 'NUMNOTA', 'HISTORICO']],
                                                                                        ["TGFDIN", _CAND['TGFDIN.COD'].concat(_CAND['TGFDIN.VLR']).concat(['NUNOTA'])]
                                                                                    ];
                                                                                    var cond = alvos.map(function (a) {
                                                                                        return "(TABLE_NAME='" + a[0] + "' AND COLUMN_NAME IN ('" + a[1].join("','") + "'))";
                                                                                    }).join(' OR ');

                                                                                    var sql = "SELECT TABLE_NAME||'.'||COLUMN_NAME AS ITEM FROM ALL_TAB_COLUMNS WHERE " + cond +
                                                                                        " UNION ALL SELECT 'TB.'||TABLE_NAME FROM ALL_TABLES WHERE TABLE_NAME IN ('TGFCTB','TGFCOM','AD_DIRAUTPROD','TGFCONT','TGFDIN')";

                                                                                    var res = await _dbQuery(sql);
                                                                                    _cap = {};
                                                                                    (res.data || []).forEach(function (r) { _cap[String(r[0]).toUpperCase()] = true; });
                                                                                    console.log('[DRE] capacidades detectadas no banco:', Object.keys(_cap).sort());
                                                                                    try { await _conferirEsquema(); } catch (e) { console.warn('[DRE] nao foi possivel conferir o esquema:', e); }
                                                                                    return _cap;
                                                                                }

                                                                                function _tem(item) { return !!(_cap && _cap[String(item).toUpperCase()]); }

                                                                                // Primeiro candidato de coluna que existe na tabela; null se nenhum
                                                                                function _colDe(tabela, chave) {
                                                                                    var cands = _CAND[chave] || [];
                                                                                    for (var i = 0; i < cands.length; i++) {
                                                                                        if (_tem(tabela + '.' + cands[i])) return cands[i];
                                                                                    }
                                                                                    return null;
                                                                                }

                                                                                // Valor da nota: campo nativo TGFCAB.VLRNOTA.
                                                                                function _exprValorNota() {
                                                                                    return 'NVL(T.VLRNOTA,0)';   // campo nativo da TGFCAB, sem funcao
                                                                                }

                                                                                // Ressalvas sobre o que o banco nao suporta
                                                                                function _avisosCapacidades() {
                                                                                    var av = [];
                                                                                    if (_faltantes && _faltantes.length) {
                                                                                        av.push('CAMPOS INEXISTENTES NO BANCO, usados pelas consultas: ' + _faltantes.join(', ')
                                                                                            + '. Corrigir no componente - os resultados podem estar incompletos ou com erro.');
                                                                                    }
                                                                                    if (!_colDe('TGFTOP', 'TGFTOP.CTB')) {
                                                                                        av.push('Nao foi encontrada coluna de "atualiza contabilidade" na TGFTOP: a regra de TOP contabilizavel (itens 7 e 9.1) nao foi aplicada.');
                                                                                    }
                                                                                    if (!_colDe('TGFCAB', 'TGFCAB.ISS')) {
                                                                                        av.push('ISS indisponivel: nao foi encontrado campo de ISS na TGFCAB (VLRISS/VLRISSQN/VLRISSRET). A natureza de ISS nao sera detalhada.');
                                                                                    }
                                                                                    if (!_tem('TB.TGFDIN') || !_colDe('TGFDIN', 'TGFDIN.COD') || !_colDe('TGFDIN', 'TGFDIN.VLR')) {
                                                                                        av.push('PIS/COFINS indisponiveis: TGFDIN ausente ou sem as colunas de imposto/valor esperadas.');
                                                                                    }
                                                                                    if (!_colDe('TCBLAN', 'TCBLAN.DEBCRED')) {
                                                                                        av.push('Nao foi encontrada coluna de debito/credito na TCBLAN: os valores contabeis estao somados sem a inversao de sinal.');
                                                                                    }
                                                                                    return av;
                                                                                }
                                                                                ...
                                                                                async function abrirModalTitulos(natId, natNome, codemp, codproj, codcencus) {
                                                                                    ...
                                                                                    if (!dtIni || !dtFim) {
                                                                                        ...
                                                                                        try {
                                                                                            await _carregarCapacidades();
                                                                                        } catch (e) {
                                                                                            console.error('[DRE] Falha ao ler o dicionario do banco:', e);
                                                                                            _renderIndisponivel('Nao foi possivel ler o dicionario do banco: ' + (e && e.message ? e.message : e), avisos);
                                                                                            return;
                                                                                        }
                                                                                        avisos = avisos.concat(_avisosCapacidades());
                                                                                        var sql = _buildSqlTitulos(natId, dtIni, dtFim, codemp, codproj, codcencus);
                                                                                        if (!sql) {
                                                                                            _renderIndisponivel('Esta natureza nao possui origem consultavel no Sankhya (digitacao manual ou "Nao Utilizado" na matriz DRE).', avisos);
                                                                                        } else {
                                                                                            try {
                                                                                                var res = await _dbQuery(sql);
                                                                                ...
                                                                                // ══════════════════════════════════════════════════════════
                                                                                // DETALHAMENTO DRE — composição dos valores conforme a
                                                                                // especificação "REGRAS – DRE GERENCIAL" + MATRIZ DRE.
                                                                                // A origem (Contabilidade / Mov. Financeira / Portal de
                                                                                // Compras / Portal de Vendas / Customização) e o sinal são
                                                                                // lidos de window.DRE_REGRAS. Nada é inferido: natureza
                                                                                // analítica sem regra é reportada como INCONSISTÊNCIA.
                                                                                // ══════════════════════════════════════════════════════════

                                                                                function _cfg() { return window.DRE_CFG || {}; }
                                                                                ...
                                                                                // Agrupa as naturezas do nó por origem/sinal da matriz DRE
                                                                                function _regrasDoNo(natId) {
                                                                                    var R = window.DRE_REGRAS || {};
                                                                                    var info = _natsDoNo(natId);
                                                                                    var g = { PV: {}, PC: {}, CTB: {}, FIN: {}, CUS: {}, NU: {}, INCONSISTENTES: [], TOTAL: 0 };
                                                                                    info.ids.forEach(function (id) {
                                                                                        var r = R[id];
                                                                                        if (!r) {
                                                                                            // Só é inconsistência quando a natureza é analítica (folha do DRE)
                                                                                            if (info.analitica[id]) g.INCONSISTENTES.push(id);
                                                                                            return;
                                                                                        }
                                                                                        g.TOTAL++;
                                                                                        if (!g[r.o]) g[r.o] = {};
                                                                                        (g[r.o][r.s] = g[r.o][r.s] || []).push(id);
                                                                                    });
                                                                                    return g;
                                                                                }

                                                                                // Aplica o sinal da matriz (Positivo / Negativo) por natureza
                                                                                function _sinalCase(expr, natCol, grupo) {
                                                                                    var pos = grupo['P'] || [], neg = grupo['N'] || [];
                                                                                    if (neg.length && pos.length) {
                                                                                        return 'CASE WHEN ' + natCol + ' IN ' + _lista(neg) + ' THEN -(' + expr + ') ELSE (' + expr + ') END';
                                                                                    }
                                                                                    if (neg.length) return '-(' + expr + ')';
                                                                                    return '(' + expr + ')';
                                                                                }

                                                                                function _todosIds(grupo) {
                                                                                    var out = [];
                                                                                    Object.keys(grupo).forEach(function (s) { out = out.concat(grupo[s]); });
                                                                                    return out;
                                                                                }

                                                                                // TOP ativa + atualiza contabilidade + configurada na TGFCTB
                                                                                function _topOk(tp, codtipoperCol) {
                                                                                    var col = _colDe('TGFTOP', 'TGFTOP.CTB');
                                                                                    if (!col) return "(1=1)";   // sem coluna no banco: regra nao aplicavel
                                                                                    var e = "(NVL(" + tp + ".ATIVO,'N')='S' AND NVL(" + tp + "." + col + ",'N')='S'";
                                                                                    if (_tem('TB.TGFCTB')) e += " AND EXISTS (SELECT 1 FROM TGFCTB CT WHERE CT.CODTIPOPER=" + codtipoperCol + ")";
                                                                                    return e + ")";
                                                                                }

                                                                                // ══════════════════════════════════════════════════════════
                                                                                // Builder oficial do detalhamento (segue a MATRIZ DRE)
                                                                                // Colunas: ORIGEM, NR_DOC, DATA_MOV, VALOR, EMPRESA,
                                                                                //          PROJETO, CR, NATUREZA, QTD, CONSIDERADO,
                                                                                //          MOTIVO, DT_ORD
                                                                                // ══════════════════════════════════════════════════════════
                                                                                function _blocosFonte(g, dtIni, dtFim, codemp, codproj, codcencus) {
                                                                                    var C = _cfg();
                                                                                    if (!g || !g.TOTAL) return null;

                                                                                    // Identificadores resolvidos contra o dicionario do banco
                                                                                    var colDC = _colDe('TCBLAN', 'TCBLAN.DEBCRED');
                                                                                    var colDinCod = _colDe('TGFDIN', 'TGFDIN.COD');
                                                                                    var colDinVlr = _colDe('TGFDIN', 'TGFDIN.VLR');
                                                                                    var temDin = _tem('TB.TGFDIN') && !!colDinCod && !!colDinVlr;

                                                                                    var D1 = "TO_DATE('" + dtIni + "','YYYY-MM-DD')";
                                                                                    var D2 = "TO_DATE('" + dtFim + "','YYYY-MM-DD')";
                                                                                    function periodoDia(col) { return '(' + col + ' >= ' + D1 + ' AND ' + col + ' < ' + D2 + ' + 1)'; }
                                                                                    function periodoMes(col) { return "(TRUNC(" + col + ",'MM') BETWEEN TRUNC(" + D1 + ",'MM') AND TRUNC(" + D2 + ",'MM'))"; }

                                                                                    // Filtros do escopo gerencial. O CR Intercompany NAO e excluido aqui:
                                                                                    // o lancamento aparece no detalhamento marcado como nao considerado.
                                                                                    function filtros(emp, proj, cr) {
                                                                                        var s = ' AND ' + emp + ' IN ' + _lista(C.EMPRESAS);
                                                                                        if (codemp != null && String(codemp) !== '' && String(codemp) !== 'null') s += ' AND ' + emp + '=' + codemp;
                                                                                        if (codproj != null && String(codproj) !== '' && String(codproj) !== 'null') s += ' AND ' + proj + '=' + codproj;
                                                                                        if (codcencus != null && String(codcencus) !== '' && String(codcencus) !== 'null') s += ' AND ' + cr + '=' + codcencus;
                                                                                        return s;
                                                                                    }

                                                                                    var INTER = C.CR_INTERCOMPANY;
                                                                                    function ehInter(cr) { return "TO_CHAR(NVL(" + cr + ",0)) LIKE '" + INTER + "%'"; }

                                                                                    // CONSIDERADO / MOTIVO combinando Intercompany + regra da TOP
                                                                                    function considerado(cr, ok) {
                                                                                        var e = "CASE WHEN " + ehInter(cr) + " THEN 'N'";
                                                                                        if (ok && ok !== '(1=1)') e += " WHEN NOT " + ok + " THEN 'N'";
                                                                                        return e + " ELSE 'S' END";
                                                                                    }
                                                                                    function motivo(cr, ok, classif) {
                                                                                        var e = "CASE WHEN " + ehInter(cr) + " THEN 'CR Intercompany " + INTER + " - nao compoe o DRE gerencial'";
                                                                                        if (ok && ok !== '(1=1)') e += " WHEN NOT " + ok + " THEN 'TOP inativa, sem atualizacao contabil ou sem configuracao na TGFCTB'";
                                                                                        return e + " ELSE '" + classif + "' END";
                                                                                    }
                                                                                    function hist(expr) { return expr || "CAST(NULL AS VARCHAR2(200))"; }

                                                                                    var blocos = [];

                                                                                    // ── 8. CONTABILIDADE (TCBLAN via contas contabeis da Natureza) ──
                                                                                    var natCTB = _todosIds(g.CTB || {});
                                                                                    if (natCTB.length) {
                                                                                        blocos.push(
                                                                                            "SELECT 'Contabilidade' AS ORIGEM," +
                                                                                            " NVL(TO_CHAR(T.NUMDOC), TO_CHAR(MIN(T.NUMLANC))) AS NR_DOC," +
                                                                                            " MAX(T.REFERENCIA) AS DT," +
                                                                                            " SUM(" + (colDC ? "CASE WHEN T." + colDC + "='D' THEN -NVL(T.VLRLANC,0) ELSE NVL(T.VLRLANC,0) END" : "NVL(T.VLRLANC,0)") + ") AS VALOR," +
                                                                                            " T.CODEMP, T.CODPROJ, T.CODCENCUS, N.CODNAT," +
                                                                                            " " + hist(_tem('TCBLAN.COMPLHIST') ? 'MAX(T.COMPLHIST)' : null) + " AS HISTORICO," +
                                                                                            " 'Cabecalho' AS CLASSIF," +
                                                                                            " " + considerado('T.CODCENCUS', null) + " AS CONSIDERADO," +
                                                                                            " " + motivo('T.CODCENCUS', null, 'Contabilidade: Natureza > Conta Contabil > TCBLAN') + " AS MOTIVO" +
                                                                                            " FROM TCBLAN T" +
                                                                                            " INNER JOIN TGFNAT N ON (N.CODCTACTB = T.CODCTACTB" +
                                                                                            (_tem('TGFNAT.CODCTACTB2') ? " OR N.CODCTACTB2 = T.CODCTACTB" : "") + ")" +
                                                                                            " WHERE N.CODNAT IN " + _lista(natCTB) +
                                                                                            " AND " + periodoMes('T.REFERENCIA') +
                                                                                            filtros('T.CODEMP', 'T.CODPROJ', 'T.CODCENCUS') +
                                                                                            " GROUP BY T.NUMDOC, T.CODEMP, T.CODPROJ, T.CODCENCUS, N.CODNAT"
                                                                                        );
                                                                                    }

                                                                                    // ── 9. MOVIMENTACAO FINANCEIRA (TGFFIN) ──
                                                                                    var natFIN = _todosIds(g.FIN || {});
                                                                                    if (natFIN.length) {
                                                                                        var joinTopFin = " LEFT JOIN TGFTOP TP ON TP.CODTIPOPER=T.CODTIPOPER"
                                                                                            + " AND TP.DHALTER=(SELECT MAX(X.DHALTER) FROM TGFTOP X WHERE X.CODTIPOPER=T.CODTIPOPER)";
                                                                                        var okFin = _topOk('TP', 'T.CODTIPOPER');
                                                                                        var histFin = hist(_tem('TGFFIN.HISTORICO') ? 'T.HISTORICO' : null);

                                                                                        // 9.a cabecalho do financeiro
                                                                                        blocos.push(
                                                                                            "SELECT 'Mov.Financeira' AS ORIGEM," +
                                                                                            " NVL(TO_CHAR(T.NUMNOTA), TO_CHAR(T.NUFIN)) AS NR_DOC," +
                                                                                            " T.DTNEG AS DT," +
                                                                                            " " + _sinalCase('NVL(T.VLRDESDOB,0)', 'T.CODNAT', g.FIN) + " AS VALOR," +
                                                                                            " T.CODEMP, T.CODPROJ, T.CODCENCUS, T.CODNAT," +
                                                                                            " " + histFin + " AS HISTORICO," +
                                                                                            " 'Cabecalho' AS CLASSIF," +
                                                                                            " " + considerado('T.CODCENCUS', okFin) + " AS CONSIDERADO," +
                                                                                            " " + motivo('T.CODCENCUS', okFin, 'Financeiro - cabecalho') + " AS MOTIVO" +
                                                                                            " FROM TGFFIN T" + joinTopFin +
                                                                                            " WHERE NVL(T.PROVISAO,'N')='N'" +
                                                                                            " AND T.CODNAT IN " + _lista(natFIN) +
                                                                                    ...
                                                                                    // ── 7. PORTAL DE COMPRAS / VENDAS (TGFCAB) ──
                                                                                    function blocosPortal(rotulo, grupo, tipmov) {
                                                                                        var ids = _todosIds(grupo || {});
                                                                                        if (!ids.length) return;
                                                                                        var joinTop = " LEFT JOIN TGFTOP TP ON TP.CODTIPOPER=T.CODTIPOPER AND TP.DHALTER=T.DHTIPOPER";
                                                                                        var ok = _topOk('TP', 'T.CODTIPOPER');
                                                                                        var vlr = _exprValorNota();
                                                                                        var histCab = hist(_tem('TGFCAB.OBSERVACAO') ? 'T.OBSERVACAO' : null);

                                                                                        // 7.1 cabecalho da nota
                                                                                        blocos.push(
                                                                                            "SELECT '" + rotulo + "' AS ORIGEM," +
                                                                                            " NVL(TO_CHAR(T.NUMNOTA), TO_CHAR(T.NUNOTA)) AS NR_DOC," +
                                                                                            " T.DTNEG AS DT," +
                                                                                            " " + _sinalCase(vlr, 'T.CODNAT', grupo) + " AS VALOR," +
                                                                                            " T.CODEMP, T.CODPROJ, T.CODCENCUS, T.CODNAT," +
                                                                                            " " + histCab + " AS HISTORICO," +
                                                                                            " 'Cabecalho' AS CLASSIF," +
                                                                                            " " + considerado('T.CODCENCUS', ok) + " AS CONSIDERADO," +
                                                                                            " " + motivo('T.CODCENCUS', ok, 'Nota liberada - cabecalho') + " AS MOTIVO" +
                                                                                            " FROM TGFCAB T" + joinTop +
                                                                                            " WHERE T.STATUSNOTA='L'" +
                                                                                            " AND T.TIPMOV IN " + tipmov +
                                                                                            " AND T.CODNAT IN " + _lista(ids) +
                                                                                            " AND " + periodoDia('T.DTNEG') +
                                                                                            filtros('T.CODEMP', 'T.CODPROJ', 'T.CODCENCUS')
                                                                                        );
                                                                                    ...
                                                                                    if (natCUS.indexOf(String(C.CODNAT_COMISSAO)) >= 0) {
                                                                                        blocos.push(
                                                                                            "SELECT 'Customizacao/Comissao' AS ORIGEM," +
                                                                                            " TO_CHAR(T.NUMNOTA) AS NR_DOC," +
                                                                                            " T.DTNEG AS DT," +
                                                                                            " -SUM(NVL(COM.VLRCOM,0)) AS VALOR," +
                                                                                            " T.CODEMP, T.CODPROJ, T.CODCENCUS, " + C.CODNAT_COMISSAO + " AS CODNAT," +
                                                                                            " MAX('Comissao sobre a nota') AS HISTORICO," +
                                                                                            " 'Cabecalho' AS CLASSIF," +
                                                                                            " MAX(" + considerado('T.CODCENCUS', null) + ") AS CONSIDERADO," +
                                                                                            " MAX(" + motivo('T.CODCENCUS', null, 'Customizacao - comissao (TGFCOM, CODFORM=6)') + ") AS MOTIVO" +
                                                                                            " FROM TGFCOM COM" +
                                                                                            " INNER JOIN TGFCAB T ON COM.NUNOTAORIG = T.NUNOTA" +
                                                                                            " WHERE COM.CODFORM = 6" +
                                                                                            " AND " + periodoDia('T.DTNEG') +
                                                                                            filtros('T.CODEMP', 'T.CODPROJ', 'T.CODCENCUS') +
                                                                                            " GROUP BY T.NUNOTA, T.NUMNOTA, T.DTNEG, T.CODEMP, T.CODPROJ, T.CODCENCUS"
                                                                                    ...
                                                                                    // ── 10.3 CUSTOMIZACAO: DIREITOS AUTORAIS ──
                                                                                    if (natCUS.indexOf(String(C.CODNAT_DIRAUT)) >= 0 && _tem('TB.AD_DIRAUTPROD')) {
                                                                                        blocos.push(
                                                                                            "SELECT 'Customizacao/Dir.Autorais' AS ORIGEM," +
                                                                                            " TO_CHAR(T.NUMNOTA) AS NR_DOC," +
                                                                                            " T.DTNEG AS DT," +
                                                                                            " -ROUND(SUM((ITE.VLRUNIT * ITE.QTDNEG) * (DIR.PERCENTUAL/100)),2) AS VALOR," +
                                                                                            " T.CODEMP, T.CODPROJ, T.CODCENCUS, " + C.CODNAT_DIRAUT + " AS CODNAT," +
                                                                                            " MAX('Direitos autorais sobre itens da nota') AS HISTORICO," +
                                                                                            " 'Cabecalho' AS CLASSIF," +
                                                                                            " MAX(" + considerado('T.CODCENCUS', null) + ") AS CONSIDERADO," +
                                                                                            " MAX(" + motivo('T.CODCENCUS', null, 'Customizacao - direitos autorais') + ") AS MOTIVO" +
                                                                                            " FROM TGFITE ITE" +
                                                                                            " INNER JOIN TGFCAB T ON T.NUNOTA = ITE.NUNOTA" +
                                                                                            " INNER JOIN TGFPAR PAR ON PAR.CODPARC = T.CODPARC" +
                                                                                            " INNER JOIN AD_DIRAUTPROD DIR ON DIR.CODPROD = ITE.CODPROD" +
                                                                                            " INNER JOIN TGFTOP TPO ON TPO.CODTIPOPER = T.CODTIPOPER AND TPO.DHALTER = T.DHTIPOPER" +
                                                                                            " WHERE T.STATUSNOTA='L' AND T.TIPMOV IN ('V','D') AND ITE.USOPROD NOT IN ('D')" +
                                                                                            " AND TPO.ATUALCOM IN ('P','L','C')" +
                                                                                            " AND NVL(PAR.AD_NAOCALCDIRAUT,'N')='N'" +
                                                                                            " AND T.CODTIPOPER IN (1718, 1714)" +
                                                                                            " AND " + periodoDia('T.DTNEG') +
                                                                                            filtros('T.CODEMP', 'T.CODPROJ', 'T.CODCENCUS') +
                                                                                            " GROUP BY T.NUNOTA, T.NUMNOTA, T.DTNEG, T.CODEMP, T.CODPROJ, T.CODCENCUS"
                                                                                        );
                                                                                ...
                                                                                // Todas as naturezas da matriz, agrupadas por origem/sinal.
                                                                                function _regrasTodas() {
                                                                                    var R = window.DRE_REGRAS || {};
                                                                                    var g = { PV: {}, PC: {}, CTB: {}, FIN: {}, CUS: {}, DIN: {}, NU: {}, INCONSISTENTES: [], TOTAL: 0 };
                                                                                ...
                                                                                // REALIZADO da tela: mesmos blocos do detalhamento, agregados.
                                                                                // Somente lancamentos com CONSIDERADO='S'. A TGFMET nao entra aqui.
                                                                                function _buildSqlRealizado(dtIni, dtFim) {
                                                                                    var blocos = _blocosFonte(_regrasTodas(), dtIni, dtFim, null, null, null);
                                                                                    if (!blocos) return null;
                                                                                    return "SELECT TO_CHAR(F.DT,'YYYY-MM') AS MES_ANO, F.ORIGEM," +
                                                                                        " F.CODEMP, NVL(E.NOMEFANTASIA, TO_CHAR(F.CODEMP)) AS EMPRESA_NOME," +
                                                                                        " F.CODPROJ, P.IDENTIFICACAO AS PROJETO_NOME," +
                                                                                        " F.CODCENCUS, C.DESCRCENCUS AS CC_NOME, C.CODUSURESP AS CODRESP, U.NOMEUSU AS RESP_NOME," +
                                                                                        " F.CODNAT, N.DESCRNAT AS NATUREZA_NOME, N.TIPNAT," +
                                                                                        " SUM(F.VALOR) AS VALOR" +
                                                                                        " FROM (" + blocos.join(' UNION ALL ') + ") F" +
                                                                                        " LEFT JOIN TSIEMP E ON E.CODEMP = F.CODEMP" +
                                                                                        " LEFT JOIN TCSPRJ P ON P.CODPROJ = F.CODPROJ" +
                                                                                        " LEFT JOIN TSICUS C ON C.CODCENCUS = F.CODCENCUS" +
                                                                                        " LEFT JOIN TSIUSU U ON U.CODUSU = C.CODUSURESP" +
                                                                                        " LEFT JOIN TGFNAT N ON N.CODNAT = F.CODNAT" +
                                                                                        " WHERE F.CONSIDERADO = 'S'" +
                                                                                        " GROUP BY TO_CHAR(F.DT,'YYYY-MM'), F.ORIGEM, F.CODEMP, E.NOMEFANTASIA, F.CODPROJ, P.IDENTIFICACAO," +
                                                                                        " F.CODCENCUS, C.DESCRCENCUS, C.CODUSURESP, U.NOMEUSU, F.CODNAT, N.DESCRNAT, N.TIPNAT";
                                                                                }
                                                                                ...
                                                                                async function _carregarRealizado(dtIni, dtFim) {
                                                                                    ...
                                                                                    if (!sql) throw new Error('Matriz DRE vazia: nenhuma natureza com origem definida.');
                                                                                    var res = await _dbQuery(sql);
                                                                                ...
                                                                                // Detalhamento: um lancamento por linha, com nomes resolvidos.
                                                                                function _buildSqlTitulos(natId, dtIni, dtFim, codemp, codproj, codcencus) {
                                                                                    var blocos = _blocosFonte(_regrasDoNo(natId), dtIni, dtFim, codemp, codproj, codcencus);
                                                                                    if (!blocos) return null;
                                                                                    return "SELECT F.ORIGEM, F.NR_DOC, TO_CHAR(F.DT,'DD/MM/YYYY') AS DATA_MOV, F.VALOR," +
                                                                                        " CASE WHEN F.VALOR >= 0 THEN F.VALOR ELSE 0 END AS VLR_REC," +
                                                                                        " CASE WHEN F.VALOR < 0 THEN F.VALOR ELSE 0 END AS VLR_DESP," +
                                                                                        " NVL(E.NOMEFANTASIA, TO_CHAR(F.CODEMP)) AS EMPRESA," +
                                                                                        " NVL(P.IDENTIFICACAO,'-') AS PROJETO," +
                                                                                        " NVL(C.DESCRCENCUS,'-') AS CR," +
                                                                                        " NVL(N.DESCRNAT, TO_CHAR(F.CODNAT)) AS NATUREZA," +
                                                                                        " NVL(F.HISTORICO,'-') AS HISTORICO, F.CLASSIF, F.CONSIDERADO, F.MOTIVO, F.DT AS DT_ORD" +
                                                                                        " FROM (" + blocos.join(' UNION ALL ') + ") F" +
                                                                                        " LEFT JOIN TSIEMP E ON E.CODEMP = F.CODEMP" +
                                                                                        " LEFT JOIN TCSPRJ P ON P.CODPROJ = F.CODPROJ" +
                                                                                        " LEFT JOIN TSICUS C ON C.CODCENCUS = F.CODCENCUS" +
                                                                                ...
                                                                                // Avisos que não vêm do banco: "Não Utilizado" e naturezas
                                                                                // analíticas fora da matriz (inconsistência).
                                                                                function _avisosDoNo(natId) {
                                                                                    var g = _regrasDoNo(natId);
                                                                                    var av = [];
                                                                                    var nu = _todosIds(g.NU || {});
                                                                                    if (nu.length) {
                                                                                        av.push('Natureza(s) marcada(s) como "Nao Utilizado" na matriz DRE: ' + nu.join(', ') + '.');
                                                                                    }
                                                                                    if (g.INCONSISTENTES.length) {
                                                                                        av.push('INCONSISTENCIA: natureza(s) analitica(s) sem origem/sinal definidos na matriz DRE: ' + g.INCONSISTENTES.join(', ') + '. Nenhuma inferencia foi feita.');
                                                                                    }
                                                                                    return av;
                                                                                }
