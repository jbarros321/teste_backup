                        ...
                        <head>
                            ...
                            <style>
                                ...
                                * {
                                ...
                                tr.row-nat:not(.collapsed) .chevron {
                                ...
                                AND RECDESP <> 0
                                    ...
                                    WHERE CAB.STATUSNOTA = 'L' AND CAB.TIPMOV IN ('V', 'D') AND ITE.USOPROD <> 'D'
                                        ...
                                        WHERE CAB.STATUSNOTA = 'L' AND CAB.TIPMOV IN ('V', 'D') AND ITE.USOPROD <> 'D'
                                            ...
                                            AND Q.DTREF < DATE '2027-01-01' GROUP BY TO_CHAR(Q.DTREF, 'YYYY-MM' ),
                                                    ...
                                                    <div class="wrap">
                                                        ...
                                                        <div class="topbar">
                                                            ...
                                                            <div class="filtros">
                                                                ...
                                                                <div class="filtro-item">
                                                                    <label>Projeto</label>
                                                                    <select id="f-proj" class="filtro" multiple
                                                                        size="3"></select>
                                                                    <span class="hint">Ctrl+clique p/ vários</span>
                                                                </div>
                                                                <div class="filtro-item">
                                                                    <label>Natureza</label>
                                                                    <select id="f-nat" class="filtro" multiple
                                                                        size="3"></select>
                                                                    <span class="hint">Ctrl+clique p/ várias</span>
                                                                </div>
                                                                <div class="filtro-item">
                                                        ...
                                                        <div class="tabela-panel">
                                                            <div class="tabela-head">
                                                                <h3 style="margin:0; font-size:0.85rem;">Detalhamento
                                                                    hierárquico &mdash; Natureza &rsaquo; detalhes
                                                                </h3>
                                                                <div
                                                            ...
                                                            <script>
                                                                document.addEventListener('DOMContentLoaded', function () {
                                                                    ...
                                                                    function popularFiltros() {
                                                                        ...
                                                                        opts(fProj, distinct('CODPROJ', 'PROJETO_NOME'), null);
                                                                        opts(fNat, distinct('CODNAT', 'NATUREZA_NOME'), null);
                                                                    ...
                                                                    function filtrar() {
                                                                        ...
                                                                        var projs = selecionados(fProj), nats = selecionados(fNat);
                                                                    ...
                                                                    function renderTabela(linhas) {
                                                                        // Hierarquia: Natureza (grupo com subtotal) -> detalhes
                                                                        // (Empresa · Projeto · Centro de Resultado · Responsável), expansíveis.
                                                                        var nats = {};
                                                                        linhas.forEach(function (r) {
                                                                            var v = valores(r);
                                                                            var kn = String(r.CODNAT);
                                                                            if (!nats[kn]) nats[kn] = { nat: r.NATUREZA_NOME, tipo: r.TIPNAT, orc: 0, real: 0, filhos: {} };
                                                                            nats[kn].orc += v.orc; nats[kn].real += v.real;
                                                                            var kf = r.CODEMP + '|' + r.CODPROJ + '|' + r.CODCENCUS + '|' + r.CODRESP;
                                                                            if (!nats[kn].filhos[kf]) nats[kn].filhos[kf] = {
                                                                                emp: r.EMPRESA_NOME, proj: r.PROJETO_NOME, cr: r.CC_NOME, resp: r.RESP_NOME, orc: 0, real: 0
                                                                            };
                                                                            nats[kn].filhos[kf].orc += v.orc; nats[kn].filhos[kf].real += v.real;
                                                                        });
                                                                        var arr = Object.keys(nats).map(function (k) { return { cod: k, d: nats[k] }; })
                                                                            .filter(function (o) { return o.d.orc !== 0 || o.d.real !== 0; })
                                                                            .sort(function (a, b) { return String(a.d.nat).localeCompare(String(b.d.nat)); });
                                                                        ...
                                                                        var html = '', totOrc = 0, totReal = 0, nFilhos = 0;
                                                                        arr.forEach(function (o) {
                                                                            ...
                                                                            var badge = n.tipo === 'R'
                                                                                ? '<span class="badge-tipo badge-R">REC</span>'
                                                                                : '<span class="badge-tipo badge-D">DESP</span>';
                                                                            var idNat = 'nat-' + o.cod;
                                                                            html +=
                                                                                '<tr class="row-nat collapsed" data-nat="' + idNat + '">' +
                                                                                '<td><span class="chevron">&#9656;</span> ' + n.nat + ' ' + badge + '</td>' +
                                                                                '<td>' + fmtBRL(n.orc) + '</td>' +
                                                                                '<td>' + fmtBRL(n.real) + '</td>' +
                                                                                '<td class="' + (saldo >= 0 ? 'val-pos' : 'val-neg') + '">' + fmtBRL(saldo) + '</td>' +
                                                                                '<td><span class="' + classeConsumo(pct) + '" style="font-weight:700;">' + fmtPct(pct) + '</span></td>' +
                                                                                '</tr>';
                                                                            var filhos = Object.keys(n.filhos).map(function (k) { return n.filhos[k]; })
                                                                            ...
                                                                            filhos.forEach(function (f) {
                                                                                ...
                                                                                html +=
                                                                                    '<tr class="row-det hidden" data-parent="' + idNat + '">' +
                                                                                    '<td class="det">' + det + '</td>' +
                                                                                    '<td>' + fmtBRL(f.orc) + '</td>' +
                                                                                    '<td>' + fmtBRL(f.real) + '</td>' +
                                                                                    '<td class="' + (s2 >= 0 ? 'val-pos' : 'val-neg') + '">' + fmtBRL(s2) + '</td>' +
                                                                                    '<td><span class="' + classeConsumo(p2) + '">' + fmtPct(p2) + '</span></td>' +
                                                                                    '</tr>';
                                                                            });
                                                                        });
                                                                        ...
                                                                        el('tab-info').textContent = arr.length + ' naturezas • ' + nFilhos + ' detalhes (clique na natureza para expandir)';
                                                                    }

                                                                    // Expandir/recolher uma natureza (delegação de clique no tbody)
                                                                    el('tbody').addEventListener('click', function (ev) {
                                                                        var tr = ev.target;
                                                                        while (tr && tr.tagName !== 'TR') tr = tr.parentNode;
                                                                        if (!tr || tr.className.indexOf('row-nat') < 0) return;
                                                                        var id = tr.getAttribute('data-nat');
                                                                        var colapsar = tr.className.indexOf('collapsed') < 0; // se não está colapsada, vamos colapsar
                                                                        if (colapsar) { if (tr.className.indexOf('collapsed') < 0) tr.className += ' collapsed'; }
                                                                        else { tr.className = tr.className.replace(/\s*collapsed/g, ''); }
                                                                        var filhos = document.querySelectorAll('tr[data-parent="' + id + '"]');
                                                                        for (var i = 0; i < filhos.length; i++) {
                                                                            if (colapsar) { if (filhos[i].className.indexOf('hidden') < 0) filhos[i].className += ' hidden'; }
                                                                            else { filhos[i].className = filhos[i].className.replace(/\s*hidden/g, ''); }
                                                                        }
                                                                    });

                                                                    function expandirTodos(expandir) {
                                                                        var nats = document.querySelectorAll('#tbody tr.row-nat');
                                                                        for (var i = 0; i < nats.length; i++) {
                                                                            if (expandir) nats[i].className = nats[i].className.replace(/\s*collapsed/g, '');
                                                                            else if (nats[i].className.indexOf('collapsed') < 0) nats[i].className += ' collapsed';
                                                                        }
                                                                    ...
                                                                    [fEmp, fCc, fProj, fNat, fResp, fOrig, fCenario, fTipo].forEach(function (f) {
                                                                    ...
                                                                    el('btn-limpar').addEventListener('click', function () {
                                                                        ...
                                                                        for (var p = 0; p < fProj.options.length; p++) fProj.options[p].selected = false;
                                                                        for (var nn = 0; nn < fNat.options.length; nn++) fNat.options[nn].selected = false;
