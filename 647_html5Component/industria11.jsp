                        ...
                        <div class="col-lg-3">
                            <div class="card kpi-card process-card card-clickable" data-kpi="volumeRealizado">
                                <div class="card-body">
                                    ...
                                    <p class="indicator-name mb-2">Média do % Realizado no período</p>
        ...
        function createLineChart(canvasId, chartData, kpi) {
            ...
            return new Chart(ctx, {
                ...
                options: {
                    ...
                    scales: {
                        y: {
                            beginAtZero: kpi === 'custoCD' || kpi === 'tempoEntrega' || kpi === 'custoEntrega' || kpi === 'qualidade' || kpi === 'volumeRealizado',
                    ...
                    plugins: {
                        legend: { display: true },
                        tooltip: { ...tooltipCustoCD, ...tooltipTempoEntrega, ...tooltipCustoEntrega, ...tooltipQualidade, ...tooltipVolumeRealizado }
                    },
