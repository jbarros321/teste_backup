...
<body>
    ...
    <script>
        ...
        // Variável global para armazenar dados reais do Custo Entrega (evolução % por mês, índice 0-11, série consolidada)
        ...
        // Card Custo Entrega: % = (TOP232 + TOP233) / TOP1101
        // PARTICIPACAO_VLRTOT calculada via JOIN (sem OVER/PARTITION BY — não suportado pelo JX)
...
WHERE CB.CODTIPOPER IN (232, 233, 1101)`;
        ...
        // Gráfico Custo Entrega: evolução mensal do %
        // PARTICIPACAO_VLRTOT calculada via JOIN (sem OVER/PARTITION BY — não suportado pelo JX)
...
ORDER BY TRUNC(CB.DTNEG, 'MM')`;
        ...
        // Detalhe Custo Entrega: registros individuais por NUNOTA/produto
        // PARTICIPACAO_VLRTOT calculada via JOIN (sem OVER/PARTITION BY — não suportado pelo JX)
...
ORDER BY CB.CODEMP, CB.DTNEG, CB.NUNOTA, CB.CODPROD`;
        ...
        // Card: % = (TOP 232 + 233) / TOP 1101 no intervalo e empresas do filtro
        ...
        // Evolução mensal do % (consolidado nas empresas selecionadas), armazenado como array índice 0-11
        ...
        // Detalhe: linhas por NUNOTA/produto; opcional mês (clique no gráfico)
        ...
        function getDataFor(kpi) {
            ...
            // Custo Entrega: evolução mensal do % consolidado (TOP232+TOP233)/TOP1101
