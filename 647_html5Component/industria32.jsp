...
<head>
    ...
    <style>
        :root {
            --app-accent: #008a70;
            --app-accent-dark: #00695e;
            --app-accent-light: #00afa0;
            --app-surface: #ffffff;
            --app-border: #e8eaeb;
            --app-muted: #6e6e6e;
            --app-header-h: 35px;
        ...
        body {
            ...
            background: linear-gradient(145deg, #f5f7f8 0%, #eef1f3 45%, #e8ecef 100%);
            color: #2c3e50;
        }
        ...
        .fixed-header {
            ...
            box-shadow: 0 4px 20px rgba(0, 138, 112, 0.28);
            z-index: 1100;
            display: flex;
            align-items: center;
        ...
        .app-main-inner { padding: 16px 20px 28px; max-width: 1600px; margin: 0 auto; }
        .app-page-toolbar {
            background: var(--app-surface);
            border-radius: 12px;
            border: 1px solid var(--app-border);
            box-shadow: 0 2px 14px rgba(0, 138, 112, 0.06);
            padding: 16px 20px;
            margin-bottom: 16px;
        }
        .app-page-eyebrow {
        ...
        .app-page-toolbar .app-page-subtitle { font-size: 0.95rem; }
        ...
        #processNav .nav-item { flex: 1 1 auto; min-width: 140px; }
        #processNav .nav-link {
        ...
        #processNav .nav-link:hover {
            color: var(--app-accent) !important;
            background: rgba(0, 138, 112, 0.06);
        }
        #processNav .nav-link.active {
            color: #fff !important;
            background: linear-gradient(135deg, var(--app-accent-light), var(--app-accent)) !important;
            border-color: transparent;
            box-shadow: 0 2px 10px rgba(0, 138, 112, 0.35);
        }
        ...
        .section-header {
            ...
            border-radius: 10px;
            border: 1px solid var(--app-border);
            border-left: 4px solid var(--app-accent-light);
            box-shadow: 0 2px 12px rgba(0, 138, 112, 0.07);
        }
        .section-header h3 { margin: 0; font-size: 1.15rem; font-weight: 700; color: #1a252f; }
        .section-header small, .section-header .section-header-meta { color: var(--app-muted); font-size: 0.8rem; }
        .section-header--industria { border-left-color: #e65100; }
        .section-header--manutencao { border-left-color: #607d8b; }
        ...
        .kpi-card h5, .kpi-card .card-title { color: #1a252f; font-size: 0.95rem; font-weight: 600; }
        .indicator-value { font-size: 1.45em; font-weight: 700; letter-spacing: -0.02em; }
        .positive { color: #1e7e34; }
        .warning { color: #c49000; }
        .negative { color: #c82333; }
        .obs-note { font-size: 0.8em; color: var(--app-muted); font-style: normal; }
        .progress { height: 8px; margin-top: 8px; border-radius: 6px; background: #eef1f3; }
        ...
        .card-overlay {
            ...
            background: linear-gradient(180deg, rgba(255,255,255,0) 0%, rgba(0,138,112,0.04) 100%);
            border-radius: 10px;
        }
        .kpi-card:hover .card-overlay { opacity: 1; }
        .card-overlay i { font-size: 2em; color: var(--app-accent); }
        .kpi-card.card-hover-chart { position: relative; }
        .kpi-card.card-hover-chart .card-overlay-chart { background: transparent; }
        .kpi-card.card-hover-chart .card-overlay-chart i { font-size: 1.25rem; color: rgba(0, 138, 112, 0.2); }
        .kpi-card.card-hover-chart:hover .card-overlay-chart i { color: rgba(0, 175, 160, 0.55); }
        ...
        .sidebar .card { border: none; background: transparent; box-shadow: none; }
        .sidebar h5 { margin-bottom: 14px; color: var(--app-accent); font-weight: 700; font-size: 1rem; }
        .sidebar .form-label { font-weight: 600; color: var(--app-muted); font-size: 0.8rem; }
        .sidebar .form-control { border-radius: 8px; border-color: var(--app-border); font-size: 0.9rem; }
        .sidebar select[multiple] { height: 150px; }
        .sidebar .btn-primary {
            background: linear-gradient(135deg, var(--app-accent-light), var(--app-accent));
            border: none;
            border-radius: 8px;
            font-weight: 600;
            padding: 10px;
        ...
        .filter-toggle-btn:hover {
            ...
            box-shadow: 0 6px 18px rgba(0, 138, 112, 0.4);
        }
        ...
        .detail-chart h6 { color: var(--app-accent); font-weight: 600; }
        #detail-view { min-height: calc(100vh - var(--app-header-h) - 120px); padding: 16px 0; }
        .kpi-cards-row { margin-bottom: 20px; }
        .kpi-charts-row { margin-top: 24px; }
        ...
        .loading-overlay .mt-3 { color: var(--app-muted); font-weight: 500; }
...
<body>
    ...
    <div class="fixed-header">
        ...
        <h1 class="header-title">Painel Indicador DTI</h1>
    </div>
    ...
    <div class="main-content" id="mainContent">
        <div class="container-fluid app-main-inner">
            <div class="app-page-toolbar">
                <p class="app-page-eyebrow">Indicadores operacionais</p>
                <p class="text-muted mb-0 app-page-subtitle" id="subtitlePeriodo">Gerenciamento de Processos</p>
            </div>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="gerir-entregas">
                    <div class="section-header">
                        <div class="row align-items-center g-2">
                            <div class="col-md-6">
                                <h3><i class="bi bi-truck me-2 text-secondary"></i>Gerir Entregas</h3>
                            </div>
                            <div class="col-md-6 text-md-end section-header-meta">
                                Extrato estoque (TOP 232+233) / TOP 1101 — % no período
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="industria">
                    <div class="section-header section-header--industria">
                        <h3><i class="bi bi-factory me-2 text-secondary"></i>Indústria</h3>
                    </div>
                ...
                <div class="tab-pane fade" id="manutencao">
                    <div class="section-header section-header--manutencao">
                        <h3><i class="bi bi-tools me-2 text-secondary"></i>Manutenção</h3>
                    </div>
                    <div class="row mb-4 kpi-cards-row">
                        <div class="col-lg-6">
    ...
    <script>
        ...
        const colors = ['#008a70', '#28a745', '#ffc107', '#dc3545', '#6f42c1'];
