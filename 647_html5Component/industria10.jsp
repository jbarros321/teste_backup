        ...
        function createLineChart(canvasId, chartData, kpi) {
            ...
            return new Chart(ctx, {
                ...
                options: {
                    ...
                    scales: {
                        y: {
                            beginAtZero: kpi === 'custoCD' || kpi === 'tempoEntrega' || kpi === 'custoEntrega' || kpi === 'qualidade',
                    ...
                    plugins: {
                        legend: { display: true },
                        tooltip: { ...tooltipCustoCD, ...tooltipTempoEntrega, ...tooltipCustoEntrega, ...tooltipQualidade }
                    },
