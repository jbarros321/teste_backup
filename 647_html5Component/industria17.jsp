...
<body>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="manutencao">
                    ...
                    <div class="row mb-4 kpi-cards-row">
                        ...
                        <div class="col-lg-4">
                            <div class="card kpi-card process-card card-clickable" data-kpi="manutencaoCorretiva">
                                <div class="card-overlay">
                                    <i class="bi bi-graph-up"></i>
                                </div>
                                <div class="card-body">
                                    <h5><i class="bi bi-wrench-adjustable text-warning me-2"></i>Manutenções Corretivas</h5>
                                    <p class="indicator-name mb-2">Participação % CO no total de ordens</p>
    ...
    <script>
        ...
        const breakdownConfigs = {
            ...
            manutencaoCorretiva: [
                { name: 'Participação Corretivas (CO)', unit: '%' },
            ...
            if (kpi === 'manutencaoCorretiva' && manutencaoCorretivaRealData && manutencaoCorretivaRealData.length > 0) {
                ...
                if (hasAny) {
                    return {
                        labels: filteredLabels,
                        datasets: [{
                            label: 'Participação Corretivas CO (%)',
                            data: filteredData,
                            borderColor: colors[0],
                            backgroundColor: colors[0] + '33',
                            tension: 0.4,
