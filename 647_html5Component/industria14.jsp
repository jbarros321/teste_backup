            ...
            return new Chart(ctx, {
                ...
                options: {
                    ...
                    interaction: { intersect: false },
                        scales: {
                        y: {
                            beginAtZero: kpi === 'custoCD' || kpi === 'tempoEntrega' || kpi === 'custoEntrega' || kpi === 'qualidade' || kpi === 'volumeRealizado' || kpi === 'ocupacaoProducao',
                    ...
                    plugins: {
                        legend: { display: true },
                        tooltip: { ...tooltipCustoCD, ...tooltipTempoEntrega, ...tooltipCustoEntrega, ...tooltipQualidade, ...tooltipVolumeRealizado, ...tooltipOcupacaoProducao }
                    },
