                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="card kpi-card process-card card-clickable" data-kpi="formulacao">
                                <div class="card-body">
                                    ...
                                    <p class="indicator-name mb-2">Conformes / total (PI)</p>
...
ORDER BY CB.CODEMP, CB.DTNEG, CB.NUNOTA, CB.CODPROD`;
        ...
        async function carregarQualidade() {
            try {
                ...
                const filtroEmpresa = `AND CAB.CODEMP IN (${empresasStr})`;
                const sql = `
                    SELECT COUNT(CASE WHEN CAB.AD_FEEDBACK = 1 THEN CAB.AD_FEEDBACK ELSE NULL END) AS PEDIDOS_CONFORME,
                           COUNT(CAB.NUNOTA) AS TOTAL_PEDIDOS,
                           ROUND(100.0 * COUNT(CASE WHEN CAB.AD_FEEDBACK = 1 THEN CAB.AD_FEEDBACK ELSE NULL END) / NULLIF(COUNT(CAB.NUNOTA), 0), 2) AS PERC
                    FROM TGFCAB CAB
                    WHERE CAB.TIPMOV = 'P'
                      AND CAB.DTNEG BETWEEN TO_DATE('${dtInicial}', 'DD-MM-YYYY') AND TO_DATE('${dtFinal}', 'DD-MM-YYYY')
